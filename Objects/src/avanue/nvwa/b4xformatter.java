...
public class b4xformatter extends B4AClass.ImplB4AClass implements BA.SubDelegator{
    ...
    private void innerInitialize(BA _ba) throws Exception {
        if (ba == null) {
            ba = new BA(_ba, this, htSubs, "avanue.nvwa.b4xformatter");
            if (htSubs == null) {
...
public String  _addformatdata(avanue.nvwa.b4xformatter._b4xformatdata _data,double _rangestart,double _rangeend,boolean _includeedges) throws Exception{
double _factor = 0;
...
public avanue.nvwa.b4xformatter._b4xformatdata  _copyformatdata(avanue.nvwa.b4xformatter._b4xformatdata _data) throws Exception{
...
public avanue.nvwa.b4xformatter._b4xformatdata  _createdefaultformat() throws Exception{
avanue.nvwa.b4xformatter._b4xformatdata _d = null;
...
public avanue.nvwa.b4xformatter._b4xformatdata  _getdefaultformat() throws Exception{
...
if (true) return (avanue.nvwa.b4xformatter._b4xformatdata)(_formats.Get((int) (0)));
 //BA.debugLineNum = 78;BA.debugLine="End Sub";
return null;
}
public avanue.nvwa.b4xformatter._b4xformatdata  _getformatdata(double _number) throws Exception{
int _i = 0;
avanue.nvwa.b4xformatter._b4xformatdata _d = null;
...
_d = (avanue.nvwa.b4xformatter._b4xformatdata)(_formats.Get(_i));
...
public avanue.nvwa.b4xformatter._b4xformatdata  _newformatdata() throws Exception{
