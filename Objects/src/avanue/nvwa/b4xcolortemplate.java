...
public class b4xcolortemplate extends B4AClass.ImplB4AClass implements BA.SubDelegator{
    ...
    private void innerInitialize(BA _ba) throws Exception {
        if (ba == null) {
            ba = new BA(_ba, this, htSubs, "avanue.nvwa.b4xcolortemplate");
            if (htSubs == null) {
...
public avanue.nvwa.b4xcolortemplate._colorpickerpart  _createpanelforbitmapcreator(String _eventname,boolean _withcheckers) throws Exception{
avanue.nvwa.b4xcolortemplate._colorpickerpart _cpp = null;
...
public String  _drawcheckers(avanue.nvwa.b4xcolortemplate._colorpickerpart _cpp) throws Exception{
int _size = 0;
int[] _clrs = null;
int _clr = 0;
anywheresoftware.b4a.objects.B4XCanvas.B4XRect _r = null;
...
public anywheresoftware.b4a.objects.B4XViewWrapper  _getpanel(avanue.nvwa.b4xdialog _dialog) throws Exception{
...
public void  _show(avanue.nvwa.b4xdialog _dialog) throws Exception{
ResumableSub_Show rsub = new ResumableSub_Show(this,_dialog);
rsub.resume(ba, null);
}
public static class ResumableSub_Show extends BA.ResumableSub {
public ResumableSub_Show(avanue.nvwa.b4xcolortemplate parent,avanue.nvwa.b4xdialog _dialog) {
this.parent = parent;
...
if (BA.fastSubCompare(sub, "GETPANEL"))
	return _getpanel((avanue.nvwa.b4xdialog) args[0]);
