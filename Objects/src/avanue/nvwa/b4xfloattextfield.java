...
public class b4xfloattextfield extends B4AClass.ImplB4AClass implements BA.SubDelegator{
    ...
    private void innerInitialize(BA _ba) throws Exception {
        if (ba == null) {
            ba = new BA(_ba, this, htSubs, "avanue.nvwa.b4xfloattextfield");
            if (htSubs == null) {
...
__c.LogImpl("916187416","Multiline not supported with password mode.",0);
 };
...
public avanue.nvwa.b4xfloattextfield  _getnextfield() throws Exception{
...
if (_mnexttextfield.IsInitialized /*boolean*/ ()==__c.False || (_mnexttextfield).equals((avanue.nvwa.b4xfloattextfield)(this))) { 
...
public String  _setnextfield(avanue.nvwa.b4xfloattextfield _field) throws Exception{
...
_mnexttextfield = (avanue.nvwa.b4xfloattextfield)(_o);
...
public ResumableSub_SwitchFromPasswordToRegular(avanue.nvwa.b4xfloattextfield parent,boolean _toregular) {
this.parent = parent;
...
if (_mnexttextfield.IsInitialized /*boolean*/ () && (_mnexttextfield).equals((avanue.nvwa.b4xfloattextfield)(this)) == false) { 
