...
public class b4xradiobutton extends B4AClass.ImplB4AClass implements BA.SubDelegator{
    ...
    private void innerInitialize(BA _ba) throws Exception {
        if (ba == null) {
            ba = new BA(_ba, this, htSubs, "avanue.nvwa.b4xradiobutton");
            if (htSubs == null) {
...
public ResumableSub_SetValueImpl(avanue.nvwa.b4xradiobutton parent,boolean _b,boolean _immediate) {
this.parent = parent;
this._b = _b;
...
//if
this.state = 10;
if ((_v).equals(parent._mbase) == false && _v.getTag() instanceof avanue.nvwa.b4xradiobutton) { 
this.state = 9;
}if (true) break;
