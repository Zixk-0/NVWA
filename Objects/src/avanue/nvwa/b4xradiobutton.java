...
public class b4xradiobutton extends B4AClass.ImplB4AClass implements BA.SubDelegator{
    ...
    private void innerInitialize(BA _ba) throws Exception {
        if (ba == null) {
            ba = new anywheresoftware.b4a.ShellBA(_ba, this, htSubs, "avanue.nvwa.b4xradiobutton");
            if (htSubs == null) {
        ...
        if (BA.isShellModeRuntimeCheck(ba)) 
			   this.getClass().getMethod("_class_globals", avanue.nvwa.b4xradiobutton.class).invoke(this, new Object[] {null});
        else
...
public String  _base_resize(avanue.nvwa.b4xradiobutton __ref,double _width1,double _height1) throws Exception{
__ref = this;
...
RDebugUtils.currentLine=22937600;
 //BA.debugLineNum = 22937600;BA.debugLine="Private Sub Base_Resize (Width1 As Double, Height1";
RDebugUtils.currentLine=22937601;
 //BA.debugLineNum = 22937601;BA.debugLine="Dim NewSize As Int = Max(5dip, Height1)";
_newsize = (int) (__c.Max(__c.DipToCurrent((int) (5)),_height1));
RDebugUtils.currentLine=22937602;
 //BA.debugLineNum = 22937602;BA.debugLine="If NewSize = Size Then Return";
if (_newsize==__ref._size /*int*/ ) { 
if (true) return "";};
RDebugUtils.currentLine=22937603;
 //BA.debugLineNum = 22937603;BA.debugLine="Size = NewSize";
__ref._size /*int*/  = _newsize;
RDebugUtils.currentLine=22937604;
 //BA.debugLineNum = 22937604;BA.debugLine="Dim gap As Int = 3dip";
_gap = __c.DipToCurrent((int) (3));
RDebugUtils.currentLine=22937606;
 //BA.debugLineNum = 22937606;BA.debugLine="bc.Initialize(NewSize - 2 * gap, NewSize - 2 * ga";
...
RDebugUtils.currentLine=22937607;
 //BA.debugLineNum = 22937607;BA.debugLine="Scale = xui.Scale";
__ref._scale /*float*/  = __ref._xui /*anywheresoftware.b4a.objects.B4XViewWrapper.XUI*/ .getScale();
RDebugUtils.currentLine=22937612;
 //BA.debugLineNum = 22937612;BA.debugLine="iv.SetLayoutAnimated(0, gap, gap, Size - 2 * gap,";
...
RDebugUtils.currentLine=22937613;
 //BA.debugLineNum = 22937613;BA.debugLine="pnl.SetLayoutAnimated(0, 0, 0, Width1, Height1)";
...
RDebugUtils.currentLine=22937614;
 //BA.debugLineNum = 22937614;BA.debugLine="mLabel.SetLayoutAnimated(0, Size + gap, 0, Width1";
...
RDebugUtils.currentLine=22937615;
 //BA.debugLineNum = 22937615;BA.debugLine="OnBrush = bc.CreateBrushFromColor(OnColor)";
...
RDebugUtils.currentLine=22937616;
 //BA.debugLineNum = 22937616;BA.debugLine="OffBrush = bc.CreateBrushFromColor(OffColor)";
...
RDebugUtils.currentLine=22937617;
 //BA.debugLineNum = 22937617;BA.debugLine="transparent = bc.CreateBrushFromColor(xui.Color_T";
__ref._transparent /*b4a.example.bcpath._bcbrush*/  = __ref._bc /*b4a.example.bitmapcreator*/ ._createbrushfromcolor(__ref._xui /*anywheresoftware.b4a.objects.B4XViewWrapper.XUI*/ .Color_Transparent);
RDebugUtils.currentLine=22937618;
 //BA.debugLineNum = 22937618;BA.debugLine="SetValueImpl(mValue, True)";
__ref._setvalueimpl /*void*/ (null,__ref._mvalue /*boolean*/ ,__c.True);
RDebugUtils.currentLine=22937619;
 //BA.debugLineNum = 22937619;BA.debugLine="End Sub";
return "";
}
public void  _setvalueimpl(avanue.nvwa.b4xradiobutton __ref,boolean _b,boolean _immediate) throws Exception{
RDebugUtils.currentModule="b4xradiobutton";
...
public ResumableSub_SetValueImpl(avanue.nvwa.b4xradiobutton parent,avanue.nvwa.b4xradiobutton __ref,boolean _b,boolean _immediate) {
this.parent = parent;
this.__ref = __ref;
this._b = _b;
...
avanue.nvwa.b4xradiobutton __ref;
avanue.nvwa.b4xradiobutton parent;
boolean _b;
boolean _immediate;
int _i = 0;
anywheresoftware.b4a.objects.B4XViewWrapper _v = null;
avanue.nvwa.b4xradiobutton _rb = null;
int _myindex = 0;
long _start = 0L;
int _duration = 0;
float _state1 = 0f;
...
RDebugUtils.currentLine=23068674;
 //BA.debugLineNum = 23068674;BA.debugLine="If b = True Then";
if (true) break;
...
RDebugUtils.currentLine=23068675;
 //BA.debugLineNum = 23068675;BA.debugLine="For i = 0 To mBase.Parent.NumberOfViews - 1";
if (true) break;
...
RDebugUtils.currentLine=23068676;
 //BA.debugLineNum = 23068676;BA.debugLine="Dim v As B4XView = mBase.Parent.GetView(i)";
...
RDebugUtils.currentLine=23068677;
 //BA.debugLineNum = 23068677;BA.debugLine="If v <> mBase And v.Tag Is B4XRadioButton Then";
if (true) break;

case 7:
//if
this.state = 10;
if ((_v).equals(__ref._mbase /*anywheresoftware.b4a.objects.B4XViewWrapper*/ ) == false && _v.getTag() instanceof avanue.nvwa.b4xradiobutton) { 
this.state = 9;
}if (true) break;
...
RDebugUtils.currentLine=23068678;
 //BA.debugLineNum = 23068678;BA.debugLine="Dim rb As B4XRadioButton = v.Tag";
_rb = (avanue.nvwa.b4xradiobutton)(_v.getTag());
RDebugUtils.currentLine=23068679;
 //BA.debugLineNum = 23068679;BA.debugLine="rb.Checked = False";
...
RDebugUtils.currentLine=23068683;
 //BA.debugLineNum = 23068683;BA.debugLine="LoopIndex = LoopIndex + 1";
__ref._loopindex /*int*/  = (int) (__ref._loopindex /*int*/ +1);
RDebugUtils.currentLine=23068684;
 //BA.debugLineNum = 23068684;BA.debugLine="If Immediate Then";
if (true) break;
...
RDebugUtils.currentLine=23068685;
 //BA.debugLineNum = 23068685;BA.debugLine="If mValue Then Draw(1) Else Draw(0)";
if (true) break;
...
RDebugUtils.currentLine=23068687;
 //BA.debugLineNum = 23068687;BA.debugLine="Dim MyIndex As Int = LoopIndex";
_myindex = __ref._loopindex /*int*/ ;
RDebugUtils.currentLine=23068688;
 //BA.debugLineNum = 23068688;BA.debugLine="Dim start As Long = DateTime.Now";
_start = parent.__c.DateTime.getNow();
RDebugUtils.currentLine=23068689;
 //BA.debugLineNum = 23068689;BA.debugLine="Dim duration As Int = 200";
_duration = (int) (200);
RDebugUtils.currentLine=23068690;
 //BA.debugLineNum = 23068690;BA.debugLine="Do While DateTime.Now < start + duration";
if (true) break;
...
RDebugUtils.currentLine=23068691;
 //BA.debugLineNum = 23068691;BA.debugLine="Dim state1 As Float = (DateTime.Now - start) /";
_state1 = (float) ((parent.__c.DateTime.getNow()-_start)/(double)_duration);
RDebugUtils.currentLine=23068692;
 //BA.debugLineNum = 23068692;BA.debugLine="If mValue = False Then state1 = 1 - state1";
if (true) break;
...
RDebugUtils.currentLine=23068693;
 //BA.debugLineNum = 23068693;BA.debugLine="Draw(state1)";
__ref._draw /*String*/ (null,_state1);
RDebugUtils.currentLine=23068694;
 //BA.debugLineNum = 23068694;BA.debugLine="Sleep(16)";
...
RDebugUtils.currentLine=23068695;
 //BA.debugLineNum = 23068695;BA.debugLine="If MyIndex <> LoopIndex Then Exit";
if (true) break;
...
RDebugUtils.currentLine=23068697;
 //BA.debugLineNum = 23068697;BA.debugLine="If MyIndex = LoopIndex Then";
...
RDebugUtils.currentLine=23068698;
 //BA.debugLineNum = 23068698;BA.debugLine="If mValue Then Draw(1) Else Draw(0)";
if (true) break;
...
RDebugUtils.currentLine=23068701;
 //BA.debugLineNum = 23068701;BA.debugLine="If mEnabled Then";
...
RDebugUtils.currentLine=23068702;
 //BA.debugLineNum = 23068702;BA.debugLine="XUIViewsUtils.SetAlpha(mBase, 1)";
...
RDebugUtils.currentLine=23068704;
 //BA.debugLineNum = 23068704;BA.debugLine="XUIViewsUtils.SetAlpha(mBase, 0.4)";
...
public String  _class_globals(avanue.nvwa.b4xradiobutton __ref) throws Exception{
__ref = this;
RDebugUtils.currentModule="b4xradiobutton";
...
RDebugUtils.currentLine=22740997;
 //BA.debugLineNum = 22740997;BA.debugLine="Public OnColor, OffColor As Int";
_oncolor = 0;
_offcolor = 0;
RDebugUtils.currentLine=22740998;
 //BA.debugLineNum = 22740998;BA.debugLine="Private bc As BitmapCreator";
_bc = new b4a.example.bitmapcreator();
RDebugUtils.currentLine=22740999;
 //BA.debugLineNum = 22740999;BA.debugLine="Private iv As B4XView";
_iv = new anywheresoftware.b4a.objects.B4XViewWrapper();
RDebugUtils.currentLine=22741000;
 //BA.debugLineNum = 22741000;BA.debugLine="Private mValue As Boolean";
_mvalue = false;
RDebugUtils.currentLine=22741001;
 //BA.debugLineNum = 22741001;BA.debugLine="Private transparent As BCBrush";
_transparent = new b4a.example.bcpath._bcbrush();
RDebugUtils.currentLine=22741002;
 //BA.debugLineNum = 22741002;BA.debugLine="Private LoopIndex As Int";
_loopindex = 0;
RDebugUtils.currentLine=22741003;
 //BA.debugLineNum = 22741003;BA.debugLine="Public Tag As Object";
_tag = new Object();
RDebugUtils.currentLine=22741004;
 //BA.debugLineNum = 22741004;BA.debugLine="Private OnBrush, OffBrush As BCBrush";
_onbrush = new b4a.example.bcpath._bcbrush();
_offbrush = new b4a.example.bcpath._bcbrush();
RDebugUtils.currentLine=22741005;
 //BA.debugLineNum = 22741005;BA.debugLine="Private mEnabled As Boolean = True";
_menabled = __c.True;
RDebugUtils.currentLine=22741006;
 //BA.debugLineNum = 22741006;BA.debugLine="Public mHaptic As Boolean";
_mhaptic = false;
...
RDebugUtils.currentLine=22741008;
 //BA.debugLineNum = 22741008;BA.debugLine="Public mLabel As B4XView";
_mlabel = new anywheresoftware.b4a.objects.B4XViewWrapper();
RDebugUtils.currentLine=22741009;
 //BA.debugLineNum = 22741009;BA.debugLine="Private pnl As B4XView";
_pnl = new anywheresoftware.b4a.objects.B4XViewWrapper();
RDebugUtils.currentLine=22741010;
 //BA.debugLineNum = 22741010;BA.debugLine="Private Scale As Float 'ignore";
_scale = 0f;
RDebugUtils.currentLine=22741011;
 //BA.debugLineNum = 22741011;BA.debugLine="End Sub";
return "";
}
public String  _designercreateview(avanue.nvwa.b4xradiobutton __ref,Object _base,anywheresoftware.b4a.objects.LabelWrapper _lbl,anywheresoftware.b4a.objects.collections.Map _props) throws Exception{
__ref = this;
RDebugUtils.currentModule="b4xradiobutton";
...
RDebugUtils.currentLine=22872067;
 //BA.debugLineNum = 22872067;BA.debugLine="mBase.SetColorAndBorder(xui.Color_Transparent, 0,";
__ref._mbase /*anywheresoftware.b4a.objects.B4XViewWrapper*/ .SetColorAndBorder(__ref._xui /*anywheresoftware.b4a.objects.B4XViewWrapper.XUI*/ .Color_Transparent,(int) (0),(int) (0),(int) (0));
RDebugUtils.currentLine=22872068;
 //BA.debugLineNum = 22872068;BA.debugLine="pnl = xui.CreatePanel(\"pnl\")";
__ref._pnl /*anywheresoftware.b4a.objects.B4XViewWrapper*/  = __ref._xui /*anywheresoftware.b4a.objects.B4XViewWrapper.XUI*/ .CreatePanel(ba,"pnl");
RDebugUtils.currentLine=22872069;
 //BA.debugLineNum = 22872069;BA.debugLine="pnl.Color = xui.Color_Transparent";
...
RDebugUtils.currentLine=22872070;
 //BA.debugLineNum = 22872070;BA.debugLine="Dim iiv As ImageView";
_iiv = new anywheresoftware.b4a.objects.ImageViewWrapper();
RDebugUtils.currentLine=22872071;
 //BA.debugLineNum = 22872071;BA.debugLine="iiv.Initialize(\"\")";
_iiv.Initialize(ba,"");
RDebugUtils.currentLine=22872072;
 //BA.debugLineNum = 22872072;BA.debugLine="iv = iiv";
__ref._iv /*anywheresoftware.b4a.objects.B4XViewWrapper*/  = (anywheresoftware.b4a.objects.B4XViewWrapper) anywheresoftware.b4a.AbsObjectWrapper.ConvertToWrapper(new anywheresoftware.b4a.objects.B4XViewWrapper(), (java.lang.Object)(_iiv.getObject()));
RDebugUtils.currentLine=22872073;
 //BA.debugLineNum = 22872073;BA.debugLine="mBase.AddView(iv, 0, 0, 0, 0)";
...
RDebugUtils.currentLine=22872074;
 //BA.debugLineNum = 22872074;BA.debugLine="mLabel = Lbl";
...
RDebugUtils.currentLine=22872075;
 //BA.debugLineNum = 22872075;BA.debugLine="mLabel.SetTextAlignment(\"CENTER\", \"LEFT\")";
__ref._mlabel /*anywheresoftware.b4a.objects.B4XViewWrapper*/ .SetTextAlignment("CENTER","LEFT");
RDebugUtils.currentLine=22872076;
 //BA.debugLineNum = 22872076;BA.debugLine="mBase.AddView(mLabel, 0, 0, 0, 0)";
...
RDebugUtils.currentLine=22872077;
 //BA.debugLineNum = 22872077;BA.debugLine="mBase.AddView(pnl, 0, 0, 0, 0)";
__ref._mbase /*anywheresoftware.b4a.objects.B4XViewWrapper*/ .AddView((android.view.View)(__ref._pnl /*anywheresoftware.b4a.objects.B4XViewWrapper*/ .getObject()),(int) (0),(int) (0),(int) (0),(int) (0));
RDebugUtils.currentLine=22872079;
 //BA.debugLineNum = 22872079;BA.debugLine="OnColor = xui.PaintOrColorToColor(Props.Get(\"OnCo";
...
RDebugUtils.currentLine=22872080;
 //BA.debugLineNum = 22872080;BA.debugLine="OffColor = xui.PaintOrColorToColor(Props.Get(\"Off";
...
RDebugUtils.currentLine=22872081;
 //BA.debugLineNum = 22872081;BA.debugLine="mHaptic = Props.GetDefault(\"HapticFeedback\", Fals";
__ref._mhaptic /*boolean*/  = BA.ObjectToBoolean(_props.GetDefault((Object)("HapticFeedback"),(Object)(__c.False)));
RDebugUtils.currentLine=22872083;
 //BA.debugLineNum = 22872083;BA.debugLine="mEnabled = mBase.Enabled";
__ref._menabled /*boolean*/  = __ref._mbase /*anywheresoftware.b4a.objects.B4XViewWrapper*/ .getEnabled();
RDebugUtils.currentLine=22872084;
 //BA.debugLineNum = 22872084;BA.debugLine="mBase.Enabled = True";
__ref._mbase /*anywheresoftware.b4a.objects.B4XViewWrapper*/ .setEnabled(__c.True);
RDebugUtils.currentLine=22872085;
 //BA.debugLineNum = 22872085;BA.debugLine="mValue = Props.Get(\"Value\")";
__ref._mvalue /*boolean*/  = BA.ObjectToBoolean(_props.Get((Object)("Value")));
RDebugUtils.currentLine=22872086;
 //BA.debugLineNum = 22872086;BA.debugLine="Base_Resize(mBase.Width, mBase.Height)";
__ref._base_resize /*String*/ (null,__ref._mbase /*anywheresoftware.b4a.objects.B4XViewWrapper*/ .getWidth(),__ref._mbase /*anywheresoftware.b4a.objects.B4XViewWrapper*/ .getHeight());
RDebugUtils.currentLine=22872087;
 //BA.debugLineNum = 22872087;BA.debugLine="End Sub";
return "";
}
public String  _draw(avanue.nvwa.b4xradiobutton __ref,float _state) throws Exception{
__ref = this;
RDebugUtils.currentModule="b4xradiobutton";
...
RDebugUtils.currentLine=23396354;
 //BA.debugLineNum = 23396354;BA.debugLine="Dim r As Float = Floor(bc.mHeight / 2)";
_r = (float) (__c.Floor(__ref._bc /*b4a.example.bitmapcreator*/ ._mheight/(double)2));
RDebugUtils.currentLine=23396355;
 //BA.debugLineNum = 23396355;BA.debugLine="If State < 1 Then bc.DrawCircle2(r, r, r, OffBrus";
if (_state<1) { 
...
RDebugUtils.currentLine=23396356;
 //BA.debugLineNum = 23396356;BA.debugLine="If State > 0 Then bc.DrawCircle2(r, r, r * State,";
if (_state>0) { 
...
RDebugUtils.currentLine=23396357;
 //BA.debugLineNum = 23396357;BA.debugLine="bc.SetBitmapToImageView(bc.Bitmap, iv)";
...
public boolean  _getchecked(avanue.nvwa.b4xradiobutton __ref) throws Exception{
__ref = this;
RDebugUtils.currentModule="b4xradiobutton";
if (Debug.shouldDelegate(ba, "getchecked", true))
	 {return ((Boolean) Debug.delegate(ba, "getchecked", null));}
RDebugUtils.currentLine=23199744;
 //BA.debugLineNum = 23199744;BA.debugLine="Public Sub getChecked As Boolean";
...
public boolean  _getenabled(avanue.nvwa.b4xradiobutton __ref) throws Exception{
__ref = this;
RDebugUtils.currentModule="b4xradiobutton";
...
public Object  _gettext(avanue.nvwa.b4xradiobutton __ref) throws Exception{
__ref = this;
RDebugUtils.currentModule="b4xradiobutton";
if (Debug.shouldDelegate(ba, "gettext", true))
	 {return ((Object) Debug.delegate(ba, "gettext", null));}
RDebugUtils.currentLine=23527424;
 //BA.debugLineNum = 23527424;BA.debugLine="Public Sub getText As Object";
RDebugUtils.currentLine=23527425;
 //BA.debugLineNum = 23527425;BA.debugLine="Return mLabel.Text";
...
public String  _initialize(avanue.nvwa.b4xradiobutton __ref,anywheresoftware.b4a.BA _ba,Object _callback,String _eventname) throws Exception{
__ref = this;
innerInitialize(_ba);
RDebugUtils.currentModule="b4xradiobutton";
...
public String  _pnl_click(avanue.nvwa.b4xradiobutton __ref) throws Exception{
__ref = this;
RDebugUtils.currentModule="b4xradiobutton";
...
RDebugUtils.currentLine=23003138;
 //BA.debugLineNum = 23003138;BA.debugLine="If mValue Then Return";
if (__ref._mvalue /*boolean*/ ) { 
if (true) return "";};
RDebugUtils.currentLine=23003139;
 //BA.debugLineNum = 23003139;BA.debugLine="If mEnabled Then";
if (__ref._menabled /*boolean*/ ) { 
RDebugUtils.currentLine=23003140;
 //BA.debugLineNum = 23003140;BA.debugLine="If mHaptic Then XUIViewsUtils.PerformHapticFeedb";
if (__ref._mhaptic /*boolean*/ ) { 
_xuiviewsutils._performhapticfeedback /*String*/ (ba,__ref._mbase /*anywheresoftware.b4a.objects.B4XViewWrapper*/ );};
RDebugUtils.currentLine=23003141;
 //BA.debugLineNum = 23003141;BA.debugLine="SetValueImpl(Not(mValue), False)";
__ref._setvalueimpl /*void*/ (null,__c.Not(__ref._mvalue /*boolean*/ ),__c.False);
RDebugUtils.currentLine=23003142;
 //BA.debugLineNum = 23003142;BA.debugLine="If mValue And xui.SubExists(mCallBack, mEventNam";
...
RDebugUtils.currentLine=23003143;
 //BA.debugLineNum = 23003143;BA.debugLine="CallSubDelayed(mCallBack, mEventName & \"_Checke";
...
public String  _setchecked(avanue.nvwa.b4xradiobutton __ref,boolean _b) throws Exception{
__ref = this;
RDebugUtils.currentModule="b4xradiobutton";
if (Debug.shouldDelegate(ba, "setchecked", true))
	 {return ((String) Debug.delegate(ba, "setchecked", new Object[] {_b}));}
RDebugUtils.currentLine=23134208;
 //BA.debugLineNum = 23134208;BA.debugLine="Public Sub setChecked(b As Boolean)";
...
public String  _setenabled(avanue.nvwa.b4xradiobutton __ref,boolean _b) throws Exception{
__ref = this;
RDebugUtils.currentModule="b4xradiobutton";
...
public String  _settext(avanue.nvwa.b4xradiobutton __ref,Object _t) throws Exception{
__ref = this;
RDebugUtils.currentModule="b4xradiobutton";
if (Debug.shouldDelegate(ba, "settext", true))
	 {return ((String) Debug.delegate(ba, "settext", new Object[] {_t}));}
RDebugUtils.currentLine=23461888;
 //BA.debugLineNum = 23461888;BA.debugLine="Public Sub setText (t As Object)";
RDebugUtils.currentLine=23461889;
 //BA.debugLineNum = 23461889;BA.debugLine="XUIViewsUtils.SetTextOrCSBuilderToLabel(mLabel, t";
