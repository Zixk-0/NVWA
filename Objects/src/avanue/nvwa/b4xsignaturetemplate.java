...
public class b4xsignaturetemplate extends B4AClass.ImplB4AClass implements BA.SubDelegator{
    ...
    private void innerInitialize(BA _ba) throws Exception {
        if (ba == null) {
            ba = new BA(_ba, this, htSubs, "avanue.nvwa.b4xsignaturetemplate");
            if (htSubs == null) {
...
public String  _show(avanue.nvwa.b4xdialog _dialog) throws Exception{
...
if (BA.fastSubCompare(sub, "SHOW"))
	return _show((avanue.nvwa.b4xdialog) args[0]);
