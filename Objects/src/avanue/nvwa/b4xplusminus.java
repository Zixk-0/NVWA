...
public class b4xplusminus extends B4AClass.ImplB4AClass implements BA.SubDelegator{
    ...
    private void innerInitialize(BA _ba) throws Exception {
        if (ba == null) {
            ba = new BA(_ba, this, htSubs, "avanue.nvwa.b4xplusminus");
            if (htSubs == null) {
...
_formatter._getdefaultformat /*avanue.nvwa.b4xformatter._b4xformatdata*/ ().FormatFont /*anywheresoftware.b4a.objects.B4XViewWrapper.B4XFont*/  = _mainlabel.getFont();
 //BA.debugLineNum = 63;BA.debugLine="Formatter.GetDefaultFormat.TextColor = MainLabel.";
_formatter._getdefaultformat /*avanue.nvwa.b4xformatter._b4xformatdata*/ ().TextColor /*int*/  = _mainlabel.getTextColor();
...
public ResumableSub_StartDownLoop(avanue.nvwa.b4xplusminus parent,boolean _up) {
this.parent = parent;
this._up = _up;
}
