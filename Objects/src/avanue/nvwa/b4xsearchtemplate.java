...
public class b4xsearchtemplate extends B4AClass.ImplB4AClass implements BA.SubDelegator{
    ...
    private void innerInitialize(BA _ba) throws Exception {
        if (ba == null) {
            ba = new BA(_ba, this, htSubs, "avanue.nvwa.b4xsearchtemplate");
            if (htSubs == null) {
...
__c.LogImpl("924313887","Index time: "+BA.NumberToString((__c.DateTime.getNow()-_starttime))+" ms ("+BA.NumberToString(_items.getSize())+" Items)",0);
...
public ResumableSub_Show(avanue.nvwa.b4xsearchtemplate parent,avanue.nvwa.b4xdialog _dialog) {
this.parent = parent;
