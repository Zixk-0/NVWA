...
try {
		Debug.PushSubsStack("Base_Resize (b4xswitch) ","b4xswitch",22,__ref.getField(false, "ba"),__ref,148);
...
try {
		Debug.PushSubsStack("DesignerCreateView (b4xswitch) ","b4xswitch",22,__ref.getField(false, "ba"),__ref,33);
...
Debug.JustUpdateDeviceLine();
__ref.runClassMethod (avanue.nvwa.b4xswitch.class, "_setvalueimpl" /*void*/ ,(Object)(BA.ObjectToBoolean(_props.runMethod(false,"Get",(Object)((RemoteObject.createImmutable("Value")))))),(Object)(b4xswitch.__c.getField(true,"True")));
...
try {
		Debug.PushSubsStack("Draw (b4xswitch) ","b4xswitch",22,__ref.getField(false, "ba"),__ref,126);
...
try {
		Debug.PushSubsStack("getEnabled (b4xswitch) ","b4xswitch",22,__ref.getField(false, "ba"),__ref,122);
...
try {
		Debug.PushSubsStack("getValue (b4xswitch) ","b4xswitch",22,__ref.getField(false, "ba"),__ref,113);
...
try {
		Debug.PushSubsStack("Initialize (b4xswitch) ","b4xswitch",22,__ref.getField(false, "ba"),__ref,27);
...
try {
		Debug.PushSubsStack("pnl_Click (b4xswitch) ","b4xswitch",22,__ref.getField(false, "ba"),__ref,70);
...
Debug.JustUpdateDeviceLine();
__ref.runClassMethod (avanue.nvwa.b4xswitch.class, "_setvalueimpl" /*void*/ ,(Object)(b4xswitch.__c.runMethod(true,"Not",(Object)(__ref.getField(true,"_mvalue" /*RemoteObject*/ )))),(Object)(b4xswitch.__c.getField(true,"False")));
...
try {
		Debug.PushSubsStack("setEnabled (b4xswitch) ","b4xswitch",22,__ref.getField(false, "ba"),__ref,117);
...
Debug.JustUpdateDeviceLine();
__ref.runClassMethod (avanue.nvwa.b4xswitch.class, "_setvalueimpl" /*void*/ ,(Object)(__ref.getField(true,"_mvalue" /*RemoteObject*/ )),(Object)(b4xswitch.__c.getField(true,"True")));
...
try {
		Debug.PushSubsStack("setValue (b4xswitch) ","b4xswitch",22,__ref.getField(false, "ba"),__ref,108);
...
Debug.JustUpdateDeviceLine();
__ref.runClassMethod (avanue.nvwa.b4xswitch.class, "_setvalueimpl" /*void*/ ,(Object)(_b),(Object)(b4xswitch.__c.getField(true,"False")));
...
try {
		Debug.PushSubsStack("SetValueImpl (b4xswitch) ","b4xswitch",22,__ref.getField(false, "ba"),__ref,81);
...
public ResumableSub_SetValueImpl(avanue.nvwa.b4xswitch parent,RemoteObject __ref,RemoteObject _b,RemoteObject _immediate) {
this.parent = parent;
this.__ref = __ref;
this._b = _b;
...
//C
this.state = 11;
__ref.runClassMethod (avanue.nvwa.b4xswitch.class, "_draw" /*RemoteObject*/ ,(Object)(BA.numberCast(float.class, 1)));
if (true) break;

case 8:
//C
this.state = 11;
__ref.runClassMethod (avanue.nvwa.b4xswitch.class, "_draw" /*RemoteObject*/ ,(Object)(BA.numberCast(float.class, 0)));
if (true) break;
...
Debug.JustUpdateDeviceLine();
__ref.runClassMethod (avanue.nvwa.b4xswitch.class, "_draw" /*RemoteObject*/ ,(Object)(_state1));
