...
try {
		Debug.PushSubsStack("AddFormatData (b4xformatter) ","b4xformatter",25,__ref.getField(false, "ba"),__ref,63);
...
try {
		Debug.PushSubsStack("CopyFormatData (b4xformatter) ","b4xformatter",25,__ref.getField(false, "ba"),__ref,36);
if (RapidSub.canDelegate("copyformatdata")) { return __ref.runUserSub(false, "b4xformatter","copyformatdata", __ref, _data);}
RemoteObject _d = RemoteObject.declareNull("avanue.nvwa.b4xformatter._b4xformatdata");
Debug.locals.put("Data", _data);
...
Debug.JustUpdateDeviceLine();
_d = RemoteObject.createNew ("avanue.nvwa.b4xformatter._b4xformatdata");Debug.locals.put("d", _d);
...
try {
		Debug.PushSubsStack("CreateDefaultFormat (b4xformatter) ","b4xformatter",25,__ref.getField(false, "ba"),__ref,17);
...
try {
		Debug.PushSubsStack("Format (b4xformatter) ","b4xformatter",25,__ref.getField(false, "ba"),__ref,90);
if (RapidSub.canDelegate("format")) { return __ref.runUserSub(false, "b4xformatter","format", __ref, _number);}
RemoteObject _data = RemoteObject.declareNull("avanue.nvwa.b4xformatter._b4xformatdata");
...
Debug.JustUpdateDeviceLine();
_data = __ref.runClassMethod (avanue.nvwa.b4xformatter.class, "_getformatdata" /*RemoteObject*/ ,(Object)(_number));Debug.locals.put("data", _data);Debug.locals.put("data", _data);
...
try {
		Debug.PushSubsStack("FormatLabel (b4xformatter) ","b4xformatter",25,__ref.getField(false, "ba"),__ref,148);
...
Debug.JustUpdateDeviceLine();
_label.runMethod(true,"setText",BA.ObjectToCharSequence(__ref.runClassMethod (avanue.nvwa.b4xformatter.class, "_format" /*RemoteObject*/ ,(Object)(_number))));
...
try {
		Debug.PushSubsStack("GetDefaultFormat (b4xformatter) ","b4xformatter",25,__ref.getField(false, "ba"),__ref,76);
...
try {
		Debug.PushSubsStack("GetFormatData (b4xformatter) ","b4xformatter",25,__ref.getField(false, "ba"),__ref,81);
...
try {
		Debug.PushSubsStack("Initialize (b4xformatter) ","b4xformatter",25,__ref.getField(false, "ba"),__ref,11);
...
Debug.JustUpdateDeviceLine();
_d = __ref.runClassMethod (avanue.nvwa.b4xformatter.class, "_createdefaultformat" /*RemoteObject*/ );Debug.locals.put("d", _d);Debug.locals.put("d", _d);
 BA.debugLineNum = 14;BA.debugLine="AddFormatData(d, MIN_VALUE, MAX_VALUE, True)";
Debug.JustUpdateDeviceLine();
__ref.runClassMethod (avanue.nvwa.b4xformatter.class, "_addformatdata" /*RemoteObject*/ ,(Object)(_d),(Object)(BA.numberCast(double.class, __ref.getField(true,"_min_value" /*RemoteObject*/ ))),(Object)(BA.numberCast(double.class, __ref.getField(true,"_max_value" /*RemoteObject*/ ))),(Object)(b4xformatter.__c.getField(true,"True")));
...
try {
		Debug.PushSubsStack("NewFormatData (b4xformatter) ","b4xformatter",25,__ref.getField(false, "ba"),__ref,30);
...
Debug.JustUpdateDeviceLine();
if (true) return __ref.runClassMethod (avanue.nvwa.b4xformatter.class, "_copyformatdata" /*RemoteObject*/ ,(Object)(__ref.runClassMethod (avanue.nvwa.b4xformatter.class, "_getdefaultformat" /*RemoteObject*/ )));
