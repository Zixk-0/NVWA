...
try {
		Debug.PushSubsStack("DialogClosed (b4xsignaturetemplate) ","b4xsignaturetemplate",21,__ref.getField(false, "ba"),__ref,56);
...
try {
		Debug.PushSubsStack("getBitmap (b4xsignaturetemplate) ","b4xsignaturetemplate",21,__ref.getField(false, "ba"),__ref,52);
...
try {
		Debug.PushSubsStack("GetPanel (b4xsignaturetemplate) ","b4xsignaturetemplate",21,__ref.getField(false, "ba"),__ref,28);
...
try {
		Debug.PushSubsStack("Initialize (b4xsignaturetemplate) ","b4xsignaturetemplate",21,__ref.getField(false, "ba"),__ref,15);
...
try {
		Debug.PushSubsStack("mBase_Touch (b4xsignaturetemplate) ","b4xsignaturetemplate",21,__ref.getField(false, "ba"),__ref,38);
...
try {
		Debug.PushSubsStack("Resize (b4xsignaturetemplate) ","b4xsignaturetemplate",21,__ref.getField(false, "ba"),__ref,22);
...
try {
		Debug.PushSubsStack("Show (b4xsignaturetemplate) ","b4xsignaturetemplate",21,__ref.getField(false, "ba"),__ref,32);
