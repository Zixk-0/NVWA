...
b4xtimedtemplate._anotherprogressbar1 = RemoteObject.createNew ("avanue.nvwa.anotherprogressbar");__ref.setField("_anotherprogressbar1",b4xtimedtemplate._anotherprogressbar1);
...
try {
		Debug.PushSubsStack("DialogClosed (b4xtimedtemplate) ","b4xtimedtemplate",23,__ref.getField(false, "ba"),__ref,41);
...
try {
		Debug.PushSubsStack("GetPanel (b4xtimedtemplate) ","b4xtimedtemplate",23,__ref.getField(false, "ba"),__ref,16);
...
try {
		Debug.PushSubsStack("Initialize (b4xtimedtemplate) ","b4xtimedtemplate",23,__ref.getField(false, "ba"),__ref,10);
...
try {
		Debug.PushSubsStack("Show (b4xtimedtemplate) ","b4xtimedtemplate",23,__ref.getField(false, "ba"),__ref,28);
...
public ResumableSub_Show(avanue.nvwa.b4xtimedtemplate parent,RemoteObject __ref,RemoteObject _dialog) {
this.parent = parent;
this.__ref = __ref;
...
Debug.JustUpdateDeviceLine();
__ref.getField(false,"_anotherprogressbar1" /*RemoteObject*/ ).runClassMethod (avanue.nvwa.anotherprogressbar.class, "_setvaluenoanimation" /*RemoteObject*/ ,(Object)(BA.numberCast(int.class, 0)));
...
Debug.JustUpdateDeviceLine();
__ref.getField(false,"_anotherprogressbar1" /*RemoteObject*/ ).runClassMethod (avanue.nvwa.anotherprogressbar.class, "_setvalue" /*RemoteObject*/ ,BA.numberCast(int.class, 100));
...
Debug.JustUpdateDeviceLine();
_dialog.runClassMethod (avanue.nvwa.b4xdialog.class, "_close" /*RemoteObject*/ ,(Object)(__ref.getField(false,"_xui" /*RemoteObject*/ ).getField(true,"DialogResponse_Cancel")));
 if (true) break;
