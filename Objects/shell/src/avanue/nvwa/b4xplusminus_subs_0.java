...
try {
		Debug.PushSubsStack("Base_Resize (b4xplusminus) ","b4xplusminus",17,__ref.getField(false, "ba"),__ref,83);
...
b4xplusminus._formatter = RemoteObject.createNew ("avanue.nvwa.b4xformatter");__ref.setField("_formatter",b4xplusminus._formatter);
...
try {
		Debug.PushSubsStack("CreateLabel (b4xplusminus) ","b4xplusminus",17,__ref.getField(false, "ba"),__ref,247);
...
try {
		Debug.PushSubsStack("Decrement (b4xplusminus) ","b4xplusminus",17,__ref.getField(false, "ba"),__ref,182);
...
Debug.JustUpdateDeviceLine();
__ref.runClassMethod (avanue.nvwa.b4xplusminus.class, "_setindex" /*RemoteObject*/ ,(Object)(RemoteObject.solve(new RemoteObject[] {__ref.getField(true,"_mselectedindex" /*RemoteObject*/ ),RemoteObject.createImmutable(1)}, "-",1, 1)),(Object)(b4xplusminus.__c.getField(true,"True")));
...
try {
		Debug.PushSubsStack("DesignerCreateView (b4xplusminus) ","b4xplusminus",17,__ref.getField(false, "ba"),__ref,38);
...
Debug.JustUpdateDeviceLine();
__ref.getField(false,"_formatter" /*RemoteObject*/ ).runClassMethod (avanue.nvwa.b4xformatter.class, "_getdefaultformat" /*RemoteObject*/ ).setField ("FormatFont" /*RemoteObject*/ ,__ref.getField(false,"_mainlabel" /*RemoteObject*/ ).runMethod(false,"getFont"));
 BA.debugLineNum = 63;BA.debugLine="Formatter.GetDefaultFormat.TextColor = MainLabel.";
Debug.JustUpdateDeviceLine();
__ref.getField(false,"_formatter" /*RemoteObject*/ ).runClassMethod (avanue.nvwa.b4xformatter.class, "_getdefaultformat" /*RemoteObject*/ ).setField ("TextColor" /*RemoteObject*/ ,__ref.getField(false,"_mainlabel" /*RemoteObject*/ ).runMethod(true,"getTextColor"));
...
Debug.JustUpdateDeviceLine();
__ref.setField ("_lblplus" /*RemoteObject*/ ,__ref.runClassMethod (avanue.nvwa.b4xplusminus.class, "_createlabel" /*RemoteObject*/ ,(Object)(BA.ObjectToString(b4xplusminus.__c.runMethod(true,"Chr",(Object)(BA.numberCast(int.class, ((int)0xe315))))))));
 BA.debugLineNum = 66;BA.debugLine="lblMinus = CreateLabel(Chr(0xE314))";
Debug.JustUpdateDeviceLine();
__ref.setField ("_lblminus" /*RemoteObject*/ ,__ref.runClassMethod (avanue.nvwa.b4xplusminus.class, "_createlabel" /*RemoteObject*/ ,(Object)(BA.ObjectToString(b4xplusminus.__c.runMethod(true,"Chr",(Object)(BA.numberCast(int.class, ((int)0xe314))))))));
 }else {
 BA.debugLineNum = 68;BA.debugLine="lblPlus = CreateLabel(Chr(0xE316))";
Debug.JustUpdateDeviceLine();
__ref.setField ("_lblplus" /*RemoteObject*/ ,__ref.runClassMethod (avanue.nvwa.b4xplusminus.class, "_createlabel" /*RemoteObject*/ ,(Object)(BA.ObjectToString(b4xplusminus.__c.runMethod(true,"Chr",(Object)(BA.numberCast(int.class, ((int)0xe316))))))));
 BA.debugLineNum = 69;BA.debugLine="lblMinus = CreateLabel(Chr(0xE313))";
Debug.JustUpdateDeviceLine();
__ref.setField ("_lblminus" /*RemoteObject*/ ,__ref.runClassMethod (avanue.nvwa.b4xplusminus.class, "_createlabel" /*RemoteObject*/ ,(Object)(BA.ObjectToString(b4xplusminus.__c.runMethod(true,"Chr",(Object)(BA.numberCast(int.class, ((int)0xe313))))))));
 };
...
Debug.JustUpdateDeviceLine();
__ref.runClassMethod (avanue.nvwa.b4xplusminus.class, "_setindex" /*RemoteObject*/ ,(Object)(BA.numberCast(int.class, -(double) (0 + 1))),(Object)(b4xplusminus.__c.getField(true,"False")));
 BA.debugLineNum = 80;BA.debugLine="Base_Resize(mBase.Width, mBase.Height)";
Debug.JustUpdateDeviceLine();
__ref.runClassMethod (avanue.nvwa.b4xplusminus.class, "_base_resize" /*RemoteObject*/ ,(Object)(BA.numberCast(double.class, __ref.getField(false,"_mbase" /*RemoteObject*/ ).runMethod(true,"getWidth"))),(Object)(BA.numberCast(double.class, __ref.getField(false,"_mbase" /*RemoteObject*/ ).runMethod(true,"getHeight"))));
...
try {
		Debug.PushSubsStack("getSelectedValue (b4xplusminus) ","b4xplusminus",17,__ref.getField(false, "ba"),__ref,117);
...
Debug.JustUpdateDeviceLine();
if (true) return __ref.runClassMethod (avanue.nvwa.b4xplusminus.class, "_getvalueimpl" /*RemoteObject*/ ,(Object)(__ref.getField(true,"_mselectedindex" /*RemoteObject*/ )));
...
try {
		Debug.PushSubsStack("GetValueImpl (b4xplusminus) ","b4xplusminus",17,__ref.getField(false, "ba"),__ref,130);
...
try {
		Debug.PushSubsStack("Increment (b4xplusminus) ","b4xplusminus",17,__ref.getField(false, "ba"),__ref,162);
...
Debug.JustUpdateDeviceLine();
_v1 = BA.numberCast(double.class, __ref.runClassMethod (avanue.nvwa.b4xplusminus.class, "_getvalueimpl" /*RemoteObject*/ ,(Object)(RemoteObject.solve(new RemoteObject[] {__ref.getField(true,"_mselectedindex" /*RemoteObject*/ ),RemoteObject.createImmutable(1)}, "+",1, 1))));Debug.locals.put("v1", _v1);Debug.locals.put("v1", _v1);
 BA.debugLineNum = 165;BA.debugLine="Dim v2 As Double = GetValueImpl(mSelectedIndex +";
Debug.JustUpdateDeviceLine();
_v2 = BA.numberCast(double.class, __ref.runClassMethod (avanue.nvwa.b4xplusminus.class, "_getvalueimpl" /*RemoteObject*/ ,(Object)(RemoteObject.solve(new RemoteObject[] {__ref.getField(true,"_mselectedindex" /*RemoteObject*/ ),RemoteObject.createImmutable(2)}, "+",1, 1))));Debug.locals.put("v2", _v2);Debug.locals.put("v2", _v2);
 BA.debugLineNum = 166;BA.debugLine="If Formatter.Format(v1) = Formatter.Format(v2) T";
Debug.JustUpdateDeviceLine();
if (RemoteObject.solveBoolean("=",__ref.getField(false,"_formatter" /*RemoteObject*/ ).runClassMethod (avanue.nvwa.b4xformatter.class, "_format" /*RemoteObject*/ ,(Object)(_v1)),__ref.getField(false,"_formatter" /*RemoteObject*/ ).runClassMethod (avanue.nvwa.b4xformatter.class, "_format" /*RemoteObject*/ ,(Object)(_v2)))) { 
...
try {
		Debug.PushSubsStack("Initialize (b4xplusminus) ","b4xplusminus",17,__ref.getField(false, "ba"),__ref,31);
...
Debug.JustUpdateDeviceLine();
__ref.getField(false,"_formatter" /*RemoteObject*/ ).runClassMethod (avanue.nvwa.b4xformatter.class, "_initialize" /*RemoteObject*/ ,__ref.getField(false, "ba"));
...
try {
		Debug.PushSubsStack("InternalSetTextOrCSBuilderToLabel (b4xplusminus) ","b4xplusminus",17,__ref.getField(false, "ba"),__ref,257);
...
try {
		Debug.PushSubsStack("pnlArrow_Touch (b4xplusminus) ","b4xplusminus",17,__ref.getField(false, "ba"),__ref,195);
...
try {
		Debug.PushSubsStack("SetIndex (b4xplusminus) ","b4xplusminus",17,__ref.getField(false, "ba"),__ref,142);
...
Debug.JustUpdateDeviceLine();
_value = __ref.runClassMethod (avanue.nvwa.b4xplusminus.class, "_getvalueimpl" /*RemoteObject*/ ,(Object)(__ref.getField(true,"_mselectedindex" /*RemoteObject*/ )));Debug.locals.put("value", _value);Debug.locals.put("value", _value);
...
Debug.JustUpdateDeviceLine();
__ref.runClassMethod (avanue.nvwa.b4xplusminus.class, "_internalsettextorcsbuildertolabel" /*RemoteObject*/ ,(Object)(__ref.getField(false,"_mainlabel" /*RemoteObject*/ )),(Object)(_value));
 }else {
 BA.debugLineNum = 152;BA.debugLine="MainLabel.Text = Formatter.Format(value)";
Debug.JustUpdateDeviceLine();
__ref.getField(false,"_mainlabel" /*RemoteObject*/ ).runMethod(true,"setText",BA.ObjectToCharSequence(__ref.getField(false,"_formatter" /*RemoteObject*/ ).runClassMethod (avanue.nvwa.b4xformatter.class, "_format" /*RemoteObject*/ ,(Object)(BA.numberCast(double.class, _value)))));
 };
...
try {
		Debug.PushSubsStack("SetNumericRange (b4xplusminus) ","b4xplusminus",17,__ref.getField(false, "ba"),__ref,108);
...
Debug.JustUpdateDeviceLine();
__ref.runClassMethod (avanue.nvwa.b4xplusminus.class, "_setindex" /*RemoteObject*/ ,(Object)(BA.numberCast(int.class, 0)),(Object)(b4xplusminus.__c.getField(true,"False")));
...
try {
		Debug.PushSubsStack("setSelectedValue (b4xplusminus) ","b4xplusminus",17,__ref.getField(false, "ba"),__ref,121);
...
Debug.JustUpdateDeviceLine();
__ref.runClassMethod (avanue.nvwa.b4xplusminus.class, "_setindex" /*RemoteObject*/ ,(Object)(__ref.getField(false,"_mstringitems" /*RemoteObject*/ ).runMethod(true,"IndexOf",(Object)(_v))),(Object)(b4xplusminus.__c.getField(true,"False")));
 }else {
...
try {
		Debug.PushSubsStack("SetStringItems (b4xplusminus) ","b4xplusminus",17,__ref.getField(false, "ba"),__ref,101);
...
try {
		Debug.PushSubsStack("StartDownLoop (b4xplusminus) ","b4xplusminus",17,__ref.getField(false, "ba"),__ref,234);
...
public ResumableSub_StartDownLoop(avanue.nvwa.b4xplusminus parent,RemoteObject __ref,RemoteObject _up) {
this.parent = parent;
this.__ref = __ref;
this._up = _up;
}
...
//C
this.state = 17;
__ref.runClassMethod (avanue.nvwa.b4xplusminus.class, "_increment" /*RemoteObject*/ );
if (true) break;

case 14:
//C
this.state = 17;
__ref.runClassMethod (avanue.nvwa.b4xplusminus.class, "_decrement" /*RemoteObject*/ );
if (true) break;
...
try {
		Debug.PushSubsStack("Touch (b4xplusminus) ","b4xplusminus",17,__ref.getField(false, "ba"),__ref,199);
...
Debug.JustUpdateDeviceLine();
__ref.runClassMethod (avanue.nvwa.b4xplusminus.class, "_startdownloop" /*void*/ ,(Object)(b4xplusminus.__c.getField(true,"True")));
 }else {
...
Debug.JustUpdateDeviceLine();
__ref.runClassMethod (avanue.nvwa.b4xplusminus.class, "_startdownloop" /*void*/ ,(Object)(b4xplusminus.__c.getField(true,"False")));
 };
 }else 
