...
try {
		Debug.PushSubsStack("Base_Resize (scrollinglabel) ","scrollinglabel",27,__ref.getField(false, "ba"),__ref,40);
...
Debug.JustUpdateDeviceLine();
__ref.runClassMethod (avanue.nvwa.scrollinglabel.class, "_settext" /*RemoteObject*/ ,(Object)(__ref.getField(true,"_mtext" /*RemoteObject*/ )));
...
try {
		Debug.PushSubsStack("DesignerCreateView (scrollinglabel) ","scrollinglabel",27,__ref.getField(false, "ba"),__ref,23);
...
try {
		Debug.PushSubsStack("getText (scrollinglabel) ","scrollinglabel",27,__ref.getField(false, "ba"),__ref,93);
...
try {
		Debug.PushSubsStack("getTextColor (scrollinglabel) ","scrollinglabel",27,__ref.getField(false, "ba"),__ref,126);
...
try {
		Debug.PushSubsStack("Initialize (scrollinglabel) ","scrollinglabel",27,__ref.getField(false, "ba"),__ref,18);
...
try {
		Debug.PushSubsStack("MeasureTextWidth (scrollinglabel) ","scrollinglabel",27,__ref.getField(false, "ba"),__ref,117);
...
try {
		Debug.PushSubsStack("setText (scrollinglabel) ","scrollinglabel",27,__ref.getField(false, "ba"),__ref,45);
...
Debug.JustUpdateDeviceLine();
_originaltextwidth = __ref.runClassMethod (avanue.nvwa.scrollinglabel.class, "_measuretextwidth" /*RemoteObject*/ ,(Object)(_t),(Object)(__ref.getField(false,"_fnt" /*RemoteObject*/ )));Debug.locals.put("originalTextWidth", _originaltextwidth);Debug.locals.put("originalTextWidth", _originaltextwidth);
...
Debug.JustUpdateDeviceLine();
__ref.runClassMethod (avanue.nvwa.scrollinglabel.class, "_stopscrolling" /*RemoteObject*/ );
 }else {
...
Debug.JustUpdateDeviceLine();
_width = __ref.runClassMethod (avanue.nvwa.scrollinglabel.class, "_measuretextwidth" /*RemoteObject*/ ,(Object)(_duplicatetext),(Object)(__ref.getField(false,"_fnt" /*RemoteObject*/ )));Debug.locals.put("Width", _width);Debug.locals.put("Width", _width);
...
Debug.JustUpdateDeviceLine();
__ref.runClassMethod (avanue.nvwa.scrollinglabel.class, "_startscrolling" /*void*/ ,(Object)(_p),(Object)(_originaltextwidth));
 };
...
try {
		Debug.PushSubsStack("setTextColor (scrollinglabel) ","scrollinglabel",27,__ref.getField(false, "ba"),__ref,121);
...
try {
		Debug.PushSubsStack("StartScrolling (scrollinglabel) ","scrollinglabel",27,__ref.getField(false, "ba"),__ref,101);
...
public ResumableSub_StartScrolling(avanue.nvwa.scrollinglabel parent,RemoteObject __ref,RemoteObject _p,RemoteObject _originalwidth) {
this.parent = parent;
this.__ref = __ref;
this._p = _p;
...
try {
		Debug.PushSubsStack("StopScrolling (scrollinglabel) ","scrollinglabel",27,__ref.getField(false, "ba"),__ref,97);
