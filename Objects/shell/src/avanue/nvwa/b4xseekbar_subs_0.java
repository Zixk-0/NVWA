...
try {
		Debug.PushSubsStack("Base_Resize (b4xseekbar) ","b4xseekbar",20,__ref.getField(false, "ba"),__ref,52);
...
Debug.JustUpdateDeviceLine();
__ref.runClassMethod (avanue.nvwa.b4xseekbar.class, "_update" /*RemoteObject*/ );
...
try {
		Debug.PushSubsStack("DesignerCreateView (b4xseekbar) ","b4xseekbar",20,__ref.getField(false, "ba"),__ref,35);
...
__ref.runClassMethod (avanue.nvwa.b4xseekbar.class, "_base_resize" /*RemoteObject*/ ,(Object)(BA.numberCast(double.class, __ref.getField(false,"_mbase" /*RemoteObject*/ ).runMethod(true,"getWidth"))),(Object)(BA.numberCast(double.class, __ref.getField(false,"_mbase" /*RemoteObject*/ ).runMethod(true,"getHeight"))));};
...
try {
		Debug.PushSubsStack("getValue (b4xseekbar) ","b4xseekbar",20,__ref.getField(false, "ba"),__ref,130);
...
try {
		Debug.PushSubsStack("Initialize (b4xseekbar) ","b4xseekbar",20,__ref.getField(false, "ba"),__ref,29);
...
try {
		Debug.PushSubsStack("RaiseTouchStateEvent (b4xseekbar) ","b4xseekbar",20,__ref.getField(false, "ba"),__ref,102);
...
try {
		Debug.PushSubsStack("setValue (b4xseekbar) ","b4xseekbar",20,__ref.getField(false, "ba"),__ref,125);
...
try {
		Debug.PushSubsStack("SetValueBasedOnTouch (b4xseekbar) ","b4xseekbar",20,__ref.getField(false, "ba"),__ref,108);
...
try {
		Debug.PushSubsStack("TouchPanel_Touch (b4xseekbar) ","b4xseekbar",20,__ref.getField(false, "ba"),__ref,88);
...
Debug.JustUpdateDeviceLine();
__ref.runClassMethod (avanue.nvwa.b4xseekbar.class, "_raisetouchstateevent" /*RemoteObject*/ );
 BA.debugLineNum = 92;BA.debugLine="SetValueBasedOnTouch(X, Y)";
Debug.JustUpdateDeviceLine();
__ref.runClassMethod (avanue.nvwa.b4xseekbar.class, "_setvaluebasedontouch" /*RemoteObject*/ ,(Object)(BA.numberCast(int.class, _x)),(Object)(BA.numberCast(int.class, _y)));
 }else 
...
try {
		Debug.PushSubsStack("Update (b4xseekbar) ","b4xseekbar",20,__ref.getField(false, "ba"),__ref,61);
