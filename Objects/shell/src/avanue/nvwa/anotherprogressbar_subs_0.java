...
try {
		Debug.PushSubsStack("Base_Resize (anotherprogressbar) ","anotherprogressbar",5,__ref.getField(false, "ba"),__ref,49);
...
Debug.JustUpdateDeviceLine();
__ref.runClassMethod (avanue.nvwa.anotherprogressbar.class, "_updategraphics" /*RemoteObject*/ );
...
try {
		Debug.PushSubsStack("BusyLoop (anotherprogressbar) ","anotherprogressbar",5,__ref.getField(false, "ba"),__ref,59);
...
public ResumableSub_BusyLoop(avanue.nvwa.anotherprogressbar parent,RemoteObject __ref) {
this.parent = parent;
this.__ref = __ref;
}
...
try {
		Debug.PushSubsStack("DesignerCreateView (anotherprogressbar) ","anotherprogressbar",5,__ref.getField(false, "ba"),__ref,32);
...
Debug.JustUpdateDeviceLine();
__ref.runClassMethod (avanue.nvwa.anotherprogressbar.class, "_setvalue" /*RemoteObject*/ ,(Object)(BA.numberCast(int.class, _props.runMethod(false,"GetDefault",(Object)(RemoteObject.createImmutable(("Value"))),(Object)(RemoteObject.createImmutable((100)))))));
...
Debug.JustUpdateDeviceLine();
__ref.runClassMethod (avanue.nvwa.anotherprogressbar.class, "_base_resize" /*RemoteObject*/ ,(Object)(BA.numberCast(double.class, __ref.getField(false,"_mbase" /*RemoteObject*/ ).runMethod(true,"getWidth"))),(Object)(BA.numberCast(double.class, __ref.getField(false,"_mbase" /*RemoteObject*/ ).runMethod(true,"getHeight"))));
...
try {
		Debug.PushSubsStack("getProgressColor (anotherprogressbar) ","anotherprogressbar",5,__ref.getField(false, "ba"),__ref,103);
...
try {
		Debug.PushSubsStack("getValue (anotherprogressbar) ","anotherprogressbar",5,__ref.getField(false, "ba"),__ref,157);
...
try {
		Debug.PushSubsStack("getVisible (anotherprogressbar) ","anotherprogressbar",5,__ref.getField(false, "ba"),__ref,153);
...
try {
		Debug.PushSubsStack("Initialize (anotherprogressbar) ","anotherprogressbar",5,__ref.getField(false, "ba"),__ref,26);
...
try {
		Debug.PushSubsStack("setProgressColor (anotherprogressbar) ","anotherprogressbar",5,__ref.getField(false, "ba"),__ref,107);
...
try {
		Debug.PushSubsStack("setValue (anotherprogressbar) ","anotherprogressbar",5,__ref.getField(false, "ba"),__ref,161);
...
try {
		Debug.PushSubsStack("SetValueNoAnimation (anotherprogressbar) ","anotherprogressbar",5,__ref.getField(false, "ba"),__ref,165);
...
Debug.JustUpdateDeviceLine();
__ref.runClassMethod (avanue.nvwa.anotherprogressbar.class, "_setvalue" /*RemoteObject*/ ,(Object)(_v));
...
try {
		Debug.PushSubsStack("setVisible (anotherprogressbar) ","anotherprogressbar",5,__ref.getField(false, "ba"),__ref,145);
...
Debug.JustUpdateDeviceLine();
__ref.runClassMethod (avanue.nvwa.anotherprogressbar.class, "_busyloop" /*void*/ );
 };
...
try {
		Debug.PushSubsStack("UpdateGraphics (anotherprogressbar) ","anotherprogressbar",5,__ref.getField(false, "ba"),__ref,112);
...
Debug.JustUpdateDeviceLine();
__ref.runClassMethod (avanue.nvwa.anotherprogressbar.class, "_setvisible" /*RemoteObject*/ ,(Object)(__ref.getField(false,"_mbase" /*RemoteObject*/ ).runMethod(true,"getVisible")));
