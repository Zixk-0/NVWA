...
try {
		Debug.PushSubsStack("Base_Resize (animatedcounter) ","animatedcounter",4,__ref.getField(false, "ba"),__ref,70);
...
_bmp = __ref.runClassMethod (avanue.nvwa.animatedcounter.class, "_createbitmap" /*RemoteObject*/ ,(Object)(__ref.getField(false,"_lbltemplate" /*RemoteObject*/ )));Debug.locals.put("bmp", _bmp);Debug.locals.put("bmp", _bmp);
...
try {
		Debug.PushSubsStack("CreateBitmap (animatedcounter) ","animatedcounter",4,__ref.getField(false, "ba"),__ref,93);
...
try {
		Debug.PushSubsStack("CreateFadeBitmap (animatedcounter) ","animatedcounter",4,__ref.getField(false, "ba"),__ref,56);
...
try {
		Debug.PushSubsStack("DesignerCreateView (animatedcounter) ","animatedcounter",4,__ref.getField(false, "ba"),__ref,30);
...
Debug.JustUpdateDeviceLine();
__ref.runClassMethod (avanue.nvwa.animatedcounter.class, "_setvalue" /*RemoteObject*/ ,(Object)(BA.numberCast(int.class, 0)));
...
Debug.JustUpdateDeviceLine();
__ref.runClassMethod (avanue.nvwa.animatedcounter.class, "_base_resize" /*RemoteObject*/ ,(Object)(BA.numberCast(double.class, __ref.getField(false,"_mbase" /*RemoteObject*/ ).runMethod(true,"getWidth"))),(Object)(BA.numberCast(double.class, __ref.getField(false,"_mbase" /*RemoteObject*/ ).runMethod(true,"getHeight"))));
 BA.debugLineNum = 52;BA.debugLine="setValue(getValue)";
Debug.JustUpdateDeviceLine();
__ref.runClassMethod (avanue.nvwa.animatedcounter.class, "_setvalue" /*RemoteObject*/ ,(Object)(__ref.runClassMethod (avanue.nvwa.animatedcounter.class, "_getvalue" /*RemoteObject*/ )));
 };
...
try {
		Debug.PushSubsStack("getValue (animatedcounter) ","animatedcounter",4,__ref.getField(false, "ba"),__ref,120);
...
try {
		Debug.PushSubsStack("Initialize (animatedcounter) ","animatedcounter",4,__ref.getField(false, "ba"),__ref,22);
...
try {
		Debug.PushSubsStack("setValue (animatedcounter) ","animatedcounter",4,__ref.getField(false, "ba"),__ref,109);
...
try {
		Debug.PushSubsStack("TopFromValue (animatedcounter) ","animatedcounter",4,__ref.getField(false, "ba"),__ref,88);
