...
b4xlisttemplate._xdialog = RemoteObject.createNew ("avanue.nvwa.b4xdialog");__ref.setField("_xdialog",b4xlisttemplate._xdialog);
...
Debug.JustUpdateDeviceLine();
__ref.runClassMethod (avanue.nvwa.b4xlisttemplate.class, "_selectitem" /*RemoteObject*/ ,(Object)(_item),(Object)(b4xlisttemplate.__c.getField(true,"True")));
 }else {
...
Debug.JustUpdateDeviceLine();
__ref.getField(false,"_xdialog" /*RemoteObject*/ ).runClassMethod (avanue.nvwa.b4xdialog.class, "_setbuttonstate" /*RemoteObject*/ ,(Object)(__ref.getField(false,"_xui" /*RemoteObject*/ ).getField(true,"DialogResponse_Positive")),(Object)(BA.ObjectToBoolean(RemoteObject.solveBoolean("g",__ref.getField(false,"_selecteditems" /*RemoteObject*/ ).runMethod(true,"getSize"),BA.numberCast(double.class, __ref.getField(true,"_multiselectionminimum" /*RemoteObject*/ ))))));
...
public ResumableSub_Show(avanue.nvwa.b4xlisttemplate parent,RemoteObject __ref,RemoteObject _dialog) {
this.parent = parent;
this.__ref = __ref;
...
Debug.JustUpdateDeviceLine();
__ref.runClassMethod (avanue.nvwa.b4xlisttemplate.class, "_selectitem" /*RemoteObject*/ ,(Object)(_item),(Object)(parent.__c.getField(true,"False")));
 if (true) break;
if (true) break;
