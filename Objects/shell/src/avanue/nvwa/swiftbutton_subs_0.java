...
try {
		Debug.PushSubsStack("Base_Resize (swiftbutton) ","swiftbutton",28,__ref.getField(false, "ba"),__ref,54);
...
Debug.JustUpdateDeviceLine();
__ref.runClassMethod (avanue.nvwa.swiftbutton.class, "_draw" /*RemoteObject*/ );
...
try {
		Debug.PushSubsStack("DesignerCreateView (swiftbutton) ","swiftbutton",28,__ref.getField(false, "ba"),__ref,32);
...
Debug.JustUpdateDeviceLine();
__ref.runClassMethod (avanue.nvwa.swiftbutton.class, "_base_resize" /*RemoteObject*/ ,(Object)(BA.numberCast(double.class, __ref.getField(false,"_mbase" /*RemoteObject*/ ).runMethod(true,"getWidth"))),(Object)(BA.numberCast(double.class, __ref.getField(false,"_mbase" /*RemoteObject*/ ).runMethod(true,"getHeight"))));
...
try {
		Debug.PushSubsStack("Draw (swiftbutton) ","swiftbutton",28,__ref.getField(false, "ba"),__ref,121);
...
try {
		Debug.PushSubsStack("getEnabled (swiftbutton) ","swiftbutton",28,__ref.getField(false, "ba"),__ref,62);
...
try {
		Debug.PushSubsStack("Initialize (swiftbutton) ","swiftbutton",28,__ref.getField(false, "ba"),__ref,27);
...
try {
		Debug.PushSubsStack("p_Touch (swiftbutton) ","swiftbutton",28,__ref.getField(false, "ba"),__ref,72);
...
Debug.JustUpdateDeviceLine();
__ref.runClassMethod (avanue.nvwa.swiftbutton.class, "_setpressedstate" /*RemoteObject*/ ,(Object)(swiftbutton.__c.getField(true,"True")));
...
Debug.JustUpdateDeviceLine();
__ref.runClassMethod (avanue.nvwa.swiftbutton.class, "_setpressedstate" /*RemoteObject*/ ,(Object)(_inside));
...
Debug.JustUpdateDeviceLine();
__ref.runClassMethod (avanue.nvwa.swiftbutton.class, "_setpressedstate" /*RemoteObject*/ ,(Object)(swiftbutton.__c.getField(true,"False")));
...
try {
		Debug.PushSubsStack("SetColors (swiftbutton) ","swiftbutton",28,__ref.getField(false, "ba"),__ref,111);
...
try {
		Debug.PushSubsStack("setEnabled (swiftbutton) ","swiftbutton",28,__ref.getField(false, "ba"),__ref,66);
...
try {
		Debug.PushSubsStack("SetPressedState (swiftbutton) ","swiftbutton",28,__ref.getField(false, "ba"),__ref,94);
...
try {
		Debug.PushSubsStack("Update (swiftbutton) ","swiftbutton",28,__ref.getField(false, "ba"),__ref,117);
