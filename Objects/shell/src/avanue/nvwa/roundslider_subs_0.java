...
try {
		Debug.PushSubsStack("Base_Resize (roundslider) ","roundslider",26,__ref.getField(false, "ba"),__ref,89);
...
__ref.runClassMethod (avanue.nvwa.roundslider.class, "_createthumb" /*RemoteObject*/ );};
...
Debug.JustUpdateDeviceLine();
__ref.runClassMethod (avanue.nvwa.roundslider.class, "_draw" /*RemoteObject*/ );
...
try {
		Debug.PushSubsStack("CreateThumb (roundslider) ","roundslider",26,__ref.getField(false, "ba"),__ref,70);
...
try {
		Debug.PushSubsStack("DesignerCreateView (roundslider) ","roundslider",26,__ref.getField(false, "ba"),__ref,35);
...
Debug.JustUpdateDeviceLine();
__ref.runClassMethod (avanue.nvwa.roundslider.class, "_base_resize" /*RemoteObject*/ ,(Object)(BA.numberCast(double.class, __ref.getField(false,"_mbase" /*RemoteObject*/ ).runMethod(true,"getWidth"))),(Object)(BA.numberCast(double.class, __ref.getField(false,"_mbase" /*RemoteObject*/ ).runMethod(true,"getHeight"))));
...
try {
		Debug.PushSubsStack("Draw (roundslider) ","roundslider",26,__ref.getField(false, "ba"),__ref,98);
...
try {
		Debug.PushSubsStack("getValue (roundslider) ","roundslider",26,__ref.getField(false, "ba"),__ref,175);
...
try {
		Debug.PushSubsStack("Initialize (roundslider) ","roundslider",26,__ref.getField(false, "ba"),__ref,29);
...
try {
		Debug.PushSubsStack("pnl_Touch (roundslider) ","roundslider",26,__ref.getField(false, "ba"),__ref,123);
...
try {
		Debug.PushSubsStack("SetCircleColor (roundslider) ","roundslider",26,__ref.getField(false, "ba"),__ref,64);
...
try {
		Debug.PushSubsStack("SetThumbColor (roundslider) ","roundslider",26,__ref.getField(false, "ba"),__ref,57);
...
try {
		Debug.PushSubsStack("setValue (roundslider) ","roundslider",26,__ref.getField(false, "ba"),__ref,170);
