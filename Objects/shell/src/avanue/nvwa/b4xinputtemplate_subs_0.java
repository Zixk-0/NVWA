...
b4xinputtemplate._xdialog = RemoteObject.createNew ("avanue.nvwa.b4xdialog");__ref.setField("_xdialog",b4xinputtemplate._xdialog);
...
try {
		Debug.PushSubsStack("ConfigureForNumbers (b4xinputtemplate) ","b4xinputtemplate",13,__ref.getField(false, "ba"),__ref,40);
...
try {
		Debug.PushSubsStack("DialogClosed (b4xinputtemplate) ","b4xinputtemplate",13,__ref.getField(false, "ba"),__ref,137);
...
try {
		Debug.PushSubsStack("GetPanel (b4xinputtemplate) ","b4xinputtemplate",13,__ref.getField(false, "ba"),__ref,116);
...
try {
		Debug.PushSubsStack("Initialize (b4xinputtemplate) ","b4xinputtemplate",13,__ref.getField(false, "ba"),__ref,16);
...
Debug.JustUpdateDeviceLine();
__ref.runClassMethod (avanue.nvwa.b4xinputtemplate.class, "_setborder" /*RemoteObject*/ ,(Object)(__ref.getField(true,"_bordercolor" /*RemoteObject*/ )));
...
try {
		Debug.PushSubsStack("IsValid (b4xinputtemplate) ","b4xinputtemplate",13,__ref.getField(false, "ba"),__ref,103);
...
try {
		Debug.PushSubsStack("SetBorder (b4xinputtemplate) ","b4xinputtemplate",13,__ref.getField(false, "ba"),__ref,99);
...
try {
		Debug.PushSubsStack("SetBorderColor (b4xinputtemplate) ","b4xinputtemplate",13,__ref.getField(false, "ba"),__ref,34);
...
try {
		Debug.PushSubsStack("Show (b4xinputtemplate) ","b4xinputtemplate",13,__ref.getField(false, "ba"),__ref,120);
...
public ResumableSub_Show(avanue.nvwa.b4xinputtemplate parent,RemoteObject __ref,RemoteObject _dialog) {
this.parent = parent;
this.__ref = __ref;
...
Debug.JustUpdateDeviceLine();
__ref.runClassMethod (avanue.nvwa.b4xinputtemplate.class, "_validate" /*RemoteObject*/ ,(Object)(__ref.getField(true,"_text" /*RemoteObject*/ )));
...
try {
		Debug.PushSubsStack("TextField1_Action (b4xinputtemplate) ","b4xinputtemplate",13,__ref.getField(false, "ba"),__ref,107);
...
Debug.JustUpdateDeviceLine();
__ref.runClassMethod (avanue.nvwa.b4xinputtemplate.class, "_textfield1_enterpressed" /*RemoteObject*/ );
...
try {
		Debug.PushSubsStack("TextField1_EnterPressed (b4xinputtemplate) ","b4xinputtemplate",13,__ref.getField(false, "ba"),__ref,111);
...
Debug.JustUpdateDeviceLine();
if (__ref.runClassMethod (avanue.nvwa.b4xinputtemplate.class, "_isvalid" /*RemoteObject*/ ,(Object)(__ref.getField(false,"_textfield1" /*RemoteObject*/ ).runMethod(true,"getText"))).<Boolean>get().booleanValue()) { 
...
try {
		Debug.PushSubsStack("TextField1_TextChanged (b4xinputtemplate) ","b4xinputtemplate",13,__ref.getField(false, "ba"),__ref,71);
...
Debug.JustUpdateDeviceLine();
__ref.runClassMethod (avanue.nvwa.b4xinputtemplate.class, "_validate" /*RemoteObject*/ ,(Object)(_new));
...
try {
		Debug.PushSubsStack("Validate (b4xinputtemplate) ","b4xinputtemplate",13,__ref.getField(false, "ba"),__ref,86);
...
Debug.JustUpdateDeviceLine();
if (RemoteObject.solveBoolean("=",__ref.runClassMethod (avanue.nvwa.b4xinputtemplate.class, "_isvalid" /*RemoteObject*/ ,(Object)(_new)),b4xinputtemplate.__c.getField(true,"False"))) { 
...
Debug.JustUpdateDeviceLine();
__ref.getField(false,"_xdialog" /*RemoteObject*/ ).runClassMethod (avanue.nvwa.b4xdialog.class, "_setbuttonstate" /*RemoteObject*/ ,(Object)(__ref.getField(false,"_xui" /*RemoteObject*/ ).getField(true,"DialogResponse_Positive")),(Object)(_enabled));
 BA.debugLineNum = 96;BA.debugLine="SetBorder(bc)";
Debug.JustUpdateDeviceLine();
__ref.runClassMethod (avanue.nvwa.b4xinputtemplate.class, "_setborder" /*RemoteObject*/ ,(Object)(_bc));
