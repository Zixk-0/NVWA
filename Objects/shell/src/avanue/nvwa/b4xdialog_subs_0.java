...
try {
		Debug.PushSubsStack("Background_Click (b4xdialog) ","b4xdialog",10,__ref.getField(false, "ba"),__ref,255);
...
try {
		Debug.PushSubsStack("Background_Touch (b4xdialog) ","b4xdialog",10,__ref.getField(false, "ba"),__ref,250);
...
try {
		Debug.PushSubsStack("Blur (b4xdialog) ","b4xdialog",10,__ref.getField(false, "ba"),__ref,284);
...
Debug.JustUpdateDeviceLine();
__ref.runClassMethod (avanue.nvwa.b4xdialog.class, "_setavg" /*RemoteObject*/ ,(Object)(_bc),(Object)(BA.numberCast(int.class, 1)),(Object)(BA.numberCast(int.class, _y)),(Object)(_clrs),(Object)(_temp));
...
Debug.JustUpdateDeviceLine();
__ref.runClassMethod (avanue.nvwa.b4xdialog.class, "_setavg" /*RemoteObject*/ ,(Object)(_bc),(Object)(BA.numberCast(int.class, _x)),(Object)(BA.numberCast(int.class, _y)),(Object)(_clrs),(Object)(_temp));
 }
}Debug.locals.put("x", _x);
;
 }
...
Debug.JustUpdateDeviceLine();
__ref.runClassMethod (avanue.nvwa.b4xdialog.class, "_setavg" /*RemoteObject*/ ,(Object)(_bc),(Object)(BA.numberCast(int.class, _x)),(Object)(BA.numberCast(int.class, 1)),(Object)(_clrs),(Object)(_temp));
...
Debug.JustUpdateDeviceLine();
b4xdialog.__c.runVoidMethod ("LogImpl","915663140",RemoteObject.concat(RemoteObject.createImmutable("Time: "),(RemoteObject.solve(new RemoteObject[] {b4xdialog.__c.getField(false,"DateTime").runMethod(true,"getNow"),_n}, "-",1, 2))),0);
...
try {
		Debug.PushSubsStack("Button_Click (b4xdialog) ","b4xdialog",10,__ref.getField(false, "ba"),__ref,230);
...
Debug.JustUpdateDeviceLine();
__ref.runClassMethod (avanue.nvwa.b4xdialog.class, "_close" /*RemoteObject*/ ,(Object)(BA.numberCast(int.class, _b.runMethod(false,"getTag"))));
...
try {
		Debug.PushSubsStack("Close (b4xdialog) ","b4xdialog",10,__ref.getField(false, "ba"),__ref,236);
...
Debug.JustUpdateDeviceLine();
if (__ref.runClassMethod (avanue.nvwa.b4xdialog.class, "_getvisible" /*RemoteObject*/ ).<Boolean>get().booleanValue()) { 
...
try {
		Debug.PushSubsStack("CreateButton (b4xdialog) ","b4xdialog",10,__ref.getField(false, "ba"),__ref,190);
...
try {
		Debug.PushSubsStack("GetButton (b4xdialog) ","b4xdialog",10,__ref.getField(false, "ba"),__ref,212);
...
try {
		Debug.PushSubsStack("getVisible (b4xdialog) ","b4xdialog",10,__ref.getField(false, "ba"),__ref,186);
...
try {
		Debug.PushSubsStack("Initialize (b4xdialog) ","b4xdialog",10,__ref.getField(false, "ba"),__ref,33);
...
try {
		Debug.PushSubsStack("InternalAddStubToCLVIfNeeded (b4xdialog) ","b4xdialog",10,__ref.getField(false, "ba"),__ref,342);
...
try {
		Debug.PushSubsStack("InternalSetTextOrCSBuilderToLabel (b4xdialog) ","b4xdialog",10,__ref.getField(false, "ba"),__ref,338);
...
try {
		Debug.PushSubsStack("Resize (b4xdialog) ","b4xdialog",10,__ref.getField(false, "ba"),__ref,260);
...
Debug.JustUpdateDeviceLine();
__ref.runClassMethod (avanue.nvwa.b4xdialog.class, "_updateblur" /*RemoteObject*/ );
 };
...
try {
		Debug.PushSubsStack("SetAvg (b4xdialog) ","b4xdialog",10,__ref.getField(false, "ba"),__ref,324);
...
try {
		Debug.PushSubsStack("SetButtonState (b4xdialog) ","b4xdialog",10,__ref.getField(false, "ba"),__ref,220);
...
Debug.JustUpdateDeviceLine();
_b = RemoteObject.createNew ("anywheresoftware.b4a.objects.B4XViewWrapper");
_b = __ref.runClassMethod (avanue.nvwa.b4xdialog.class, "_getbutton" /*RemoteObject*/ ,(Object)(_resultcode));Debug.locals.put("b", _b);Debug.locals.put("b", _b);
...
try {
		Debug.PushSubsStack("Show (b4xdialog) ","b4xdialog",10,__ref.getField(false, "ba"),__ref,71);
...
public ResumableSub_Show(avanue.nvwa.b4xdialog parent,RemoteObject __ref,RemoteObject _text,RemoteObject _yes,RemoteObject _no,RemoteObject _cancel) {
this.parent = parent;
this.__ref = __ref;
this._text = _text;
this._yes = _yes;
...
Debug.JustUpdateDeviceLine();
parent.__c.runVoidMethod ("WaitFor","complete", __ref.getField(false, "ba"), anywheresoftware.b4a.pc.PCResumableSub.createDebugResumeSub(this, "b4xdialog", "show"), __ref.runClassMethod (avanue.nvwa.b4xdialog.class, "_showcustom" /*RemoteObject*/ ,(Object)(_p),(Object)(_yes),(Object)(_no),(Object)(_cancel)));
this.state = 1;
return;
case 1:
//C
...
try {
		Debug.PushSubsStack("ShowCustom (b4xdialog) ","b4xdialog",10,__ref.getField(false, "ba"),__ref,94);
...
public ResumableSub_ShowCustom(avanue.nvwa.b4xdialog parent,RemoteObject __ref,RemoteObject _content,RemoteObject _yes,RemoteObject _no,RemoteObject _cancel) {
this.parent = parent;
this.__ref = __ref;
...
Debug.JustUpdateDeviceLine();
__ref.runClassMethod (avanue.nvwa.b4xdialog.class, "_createbutton" /*RemoteObject*/ ,(Object)(_cancel),(Object)(_btype));
 if (true) break;
...
Debug.JustUpdateDeviceLine();
__ref.runClassMethod (avanue.nvwa.b4xdialog.class, "_createbutton" /*RemoteObject*/ ,(Object)(_no),(Object)(_btype));
 if (true) break;
...
Debug.JustUpdateDeviceLine();
__ref.runClassMethod (avanue.nvwa.b4xdialog.class, "_createbutton" /*RemoteObject*/ ,(Object)(_yes),(Object)(_btype));
 if (true) break;
...
try {
		Debug.PushSubsStack("ShowTemplate (b4xdialog) ","b4xdialog",10,__ref.getField(false, "ba"),__ref,62);
...
public ResumableSub_ShowTemplate(avanue.nvwa.b4xdialog parent,RemoteObject __ref,RemoteObject _dialogtemplate,RemoteObject _yes,RemoteObject _no,RemoteObject _cancel) {
this.parent = parent;
this.__ref = __ref;
...
Debug.JustUpdateDeviceLine();
parent.__c.runVoidMethod ("WaitFor","complete", __ref.getField(false, "ba"), anywheresoftware.b4a.pc.PCResumableSub.createDebugResumeSub(this, "b4xdialog", "showtemplate"), __ref.runClassMethod (avanue.nvwa.b4xdialog.class, "_showcustom" /*RemoteObject*/ ,(Object)(_content),(Object)(_yes),(Object)(_no),(Object)(_cancel)));
this.state = 1;
return;
case 1:
//C
...
try {
		Debug.PushSubsStack("Stub_Click (b4xdialog) ","b4xdialog",10,__ref.getField(false, "ba"),__ref,348);
...
try {
		Debug.PushSubsStack("UpdateBlur (b4xdialog) ","b4xdialog",10,__ref.getField(false, "ba"),__ref,271);
...
Debug.JustUpdateDeviceLine();
_blurred = __ref.runClassMethod (avanue.nvwa.b4xdialog.class, "_blur" /*RemoteObject*/ ,(Object)(_source));Debug.locals.put("blurred", _blurred);Debug.locals.put("blurred", _blurred);
