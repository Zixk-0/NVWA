...
try {
		Debug.PushSubsStack("Base_Resize (b4xradiobutton) ","b4xradiobutton",18,__ref.getField(false, "ba"),__ref,59);
...
Debug.JustUpdateDeviceLine();
__ref.runClassMethod (avanue.nvwa.b4xradiobutton.class, "_setvalueimpl" /*void*/ ,(Object)(__ref.getField(true,"_mvalue" /*RemoteObject*/ )),(Object)(b4xradiobutton.__c.getField(true,"True")));
...
try {
		Debug.PushSubsStack("DesignerCreateView (b4xradiobutton) ","b4xradiobutton",18,__ref.getField(false, "ba"),__ref,33);
...
Debug.JustUpdateDeviceLine();
__ref.runClassMethod (avanue.nvwa.b4xradiobutton.class, "_base_resize" /*RemoteObject*/ ,(Object)(BA.numberCast(double.class, __ref.getField(false,"_mbase" /*RemoteObject*/ ).runMethod(true,"getWidth"))),(Object)(BA.numberCast(double.class, __ref.getField(false,"_mbase" /*RemoteObject*/ ).runMethod(true,"getHeight"))));
...
try {
		Debug.PushSubsStack("Draw (b4xradiobutton) ","b4xradiobutton",18,__ref.getField(false, "ba"),__ref,153);
...
try {
		Debug.PushSubsStack("getChecked (b4xradiobutton) ","b4xradiobutton",18,__ref.getField(false, "ba"),__ref,140);
...
try {
		Debug.PushSubsStack("getEnabled (b4xradiobutton) ","b4xradiobutton",18,__ref.getField(false, "ba"),__ref,149);
...
try {
		Debug.PushSubsStack("getText (b4xradiobutton) ","b4xradiobutton",18,__ref.getField(false, "ba"),__ref,165);
...
try {
		Debug.PushSubsStack("Initialize (b4xradiobutton) ","b4xradiobutton",18,__ref.getField(false, "ba"),__ref,27);
...
try {
		Debug.PushSubsStack("pnl_Click (b4xradiobutton) ","b4xradiobutton",18,__ref.getField(false, "ba"),__ref,86);
...
Debug.JustUpdateDeviceLine();
__ref.runClassMethod (avanue.nvwa.b4xradiobutton.class, "_setvalueimpl" /*void*/ ,(Object)(b4xradiobutton.__c.runMethod(true,"Not",(Object)(__ref.getField(true,"_mvalue" /*RemoteObject*/ )))),(Object)(b4xradiobutton.__c.getField(true,"False")));
...
try {
		Debug.PushSubsStack("setChecked (b4xradiobutton) ","b4xradiobutton",18,__ref.getField(false, "ba"),__ref,135);
...
Debug.JustUpdateDeviceLine();
__ref.runClassMethod (avanue.nvwa.b4xradiobutton.class, "_setvalueimpl" /*void*/ ,(Object)(_b),(Object)(b4xradiobutton.__c.getField(true,"False")));
...
try {
		Debug.PushSubsStack("setEnabled (b4xradiobutton) ","b4xradiobutton",18,__ref.getField(false, "ba"),__ref,144);
...
try {
		Debug.PushSubsStack("setText (b4xradiobutton) ","b4xradiobutton",18,__ref.getField(false, "ba"),__ref,161);
...
try {
		Debug.PushSubsStack("SetValueImpl (b4xradiobutton) ","b4xradiobutton",18,__ref.getField(false, "ba"),__ref,98);
...
public ResumableSub_SetValueImpl(avanue.nvwa.b4xradiobutton parent,RemoteObject __ref,RemoteObject _b,RemoteObject _immediate) {
this.parent = parent;
this.__ref = __ref;
this._b = _b;
...
RemoteObject _rb = RemoteObject.declareNull("avanue.nvwa.b4xradiobutton");
...
//if
this.state = 10;
if (RemoteObject.solveBoolean("!",_v,__ref.getField(false,"_mbase" /*RemoteObject*/ )) && RemoteObject.solveBoolean("i",_v.runMethod(false,"getTag"), RemoteObject.createImmutable("avanue.nvwa.b4xradiobutton"))) { 
this.state = 9;
}if (true) break;
...
Debug.JustUpdateDeviceLine();
_rb.runClassMethod (avanue.nvwa.b4xradiobutton.class, "_setchecked" /*RemoteObject*/ ,parent.__c.getField(true,"False"));
 if (true) break;
...
//C
this.state = 23;
__ref.runClassMethod (avanue.nvwa.b4xradiobutton.class, "_draw" /*RemoteObject*/ ,(Object)(BA.numberCast(float.class, 1)));
if (true) break;

case 20:
//C
this.state = 23;
__ref.runClassMethod (avanue.nvwa.b4xradiobutton.class, "_draw" /*RemoteObject*/ ,(Object)(BA.numberCast(float.class, 0)));
if (true) break;
...
Debug.JustUpdateDeviceLine();
__ref.runClassMethod (avanue.nvwa.b4xradiobutton.class, "_draw" /*RemoteObject*/ ,(Object)(_state1));
