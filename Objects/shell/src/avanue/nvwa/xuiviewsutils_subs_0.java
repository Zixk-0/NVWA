...
try {
		Debug.PushSubsStack("AddStubToCLVIfNeeded (xuiviewsutils) ","xuiviewsutils",29,_ba,xuiviewsutils.mostCurrent,34);
if (RapidSub.canDelegate("addstubtoclvifneeded")) { return avanue.nvwa.xuiviewsutils.remoteMe.runUserSub(false, "xuiviewsutils","addstubtoclvifneeded", _ba, _customlistview1, _color);}
...
try {
		Debug.PushSubsStack("CreateB4XImageView (xuiviewsutils) ","xuiviewsutils",29,_ba,xuiviewsutils.mostCurrent,85);
if (RapidSub.canDelegate("createb4ximageview")) { return avanue.nvwa.xuiviewsutils.remoteMe.runUserSub(false, "xuiviewsutils","createb4ximageview", _ba);}
RemoteObject _iv = RemoteObject.declareNull("avanue.nvwa.b4ximageview");
...
Debug.JustUpdateDeviceLine();
_iv = RemoteObject.createNew ("avanue.nvwa.b4ximageview");Debug.locals.put("iv", _iv);
 BA.debugLineNum = 87;BA.debugLine="iv.Initialize(Null, \"\")";
Debug.JustUpdateDeviceLine();
_iv.runClassMethod (avanue.nvwa.b4ximageview.class, "_initialize" /*RemoteObject*/ ,_ba,(Object)(xuiviewsutils.mostCurrent.__c.getField(false,"Null")),(Object)(RemoteObject.createImmutable("")));
...
try {
		Debug.PushSubsStack("CreateLabel (xuiviewsutils) ","xuiviewsutils",29,_ba,xuiviewsutils.mostCurrent,78);
if (RapidSub.canDelegate("createlabel")) { return avanue.nvwa.xuiviewsutils.remoteMe.runUserSub(false, "xuiviewsutils","createlabel", _ba);}
...
try {
		Debug.PushSubsStack("Initialize (xuiviewsutils) ","xuiviewsutils",29,_ba,xuiviewsutils.mostCurrent,10);
if (RapidSub.canDelegate("initialize")) { return avanue.nvwa.xuiviewsutils.remoteMe.runUserSub(false, "xuiviewsutils","initialize", _ba);}
;
...
try {
		Debug.PushSubsStack("PerformHapticFeedback (xuiviewsutils) ","xuiviewsutils",29,_ba,xuiviewsutils.mostCurrent,21);
if (RapidSub.canDelegate("performhapticfeedback")) { return avanue.nvwa.xuiviewsutils.remoteMe.runUserSub(false, "xuiviewsutils","performhapticfeedback", _ba, _view);}
...
try {
		Debug.PushSubsStack("SetAlpha (xuiviewsutils) ","xuiviewsutils",29,_ba,xuiviewsutils.mostCurrent,95);
if (RapidSub.canDelegate("setalpha")) { return avanue.nvwa.xuiviewsutils.remoteMe.runUserSub(false, "xuiviewsutils","setalpha", _ba, _view, _level);}
RemoteObject _jo = RemoteObject.declareNull("anywheresoftware.b4j.object.JavaObject");
...
try {
		Debug.PushSubsStack("SetBitmapAndFill (xuiviewsutils) ","xuiviewsutils",29,_ba,xuiviewsutils.mostCurrent,65);
if (RapidSub.canDelegate("setbitmapandfill")) { return avanue.nvwa.xuiviewsutils.remoteMe.runUserSub(false, "xuiviewsutils","setbitmapandfill", _ba, _imageview, _bmp);}
...
try {
		Debug.PushSubsStack("SetTextOrCSBuilderToLabel (xuiviewsutils) ","xuiviewsutils",29,_ba,xuiviewsutils.mostCurrent,50);
if (RapidSub.canDelegate("settextorcsbuildertolabel")) { return avanue.nvwa.xuiviewsutils.remoteMe.runUserSub(false, "xuiviewsutils","settextorcsbuildertolabel", _ba, _xlbl, _text);}
;
