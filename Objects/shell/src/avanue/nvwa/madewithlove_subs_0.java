...
try {
		Debug.PushSubsStack("Base_Resize (madewithlove) ","madewithlove",24,__ref.getField(false, "ba"),__ref,47);
...
try {
		Debug.PushSubsStack("DesignerCreateView (madewithlove) ","madewithlove",24,__ref.getField(false, "ba"),__ref,15);
...
try {
		Debug.PushSubsStack("Initialize (madewithlove) ","madewithlove",24,__ref.getField(false, "ba"),__ref,9);
