...
try {
		Debug.PushSubsStack("btnMonth_Click (b4xdatetemplate) ","b4xdatetemplate",9,__ref.getField(false, "ba"),__ref,160);
...
Debug.JustUpdateDeviceLine();
__ref.runClassMethod (avanue.nvwa.b4xdatetemplate.class, "_drawdays" /*RemoteObject*/ );
...
try {
		Debug.PushSubsStack("btnYear_Click (b4xdatetemplate) ","b4xdatetemplate",9,__ref.getField(false, "ba"),__ref,154);
...
b4xdatetemplate._mdialog = RemoteObject.createNew ("avanue.nvwa.b4xdialog");__ref.setField("_mdialog",b4xdatetemplate._mdialog);
...
try {
		Debug.PushSubsStack("DaysPaneFg_Touch (b4xdatetemplate) ","b4xdatetemplate",9,__ref.getField(false, "ba"),__ref,167);
...
Debug.JustUpdateDeviceLine();
__ref.runClassMethod (avanue.nvwa.b4xdatetemplate.class, "_handlemouse" /*RemoteObject*/ ,(Object)(BA.numberCast(double.class, _x)),(Object)(BA.numberCast(double.class, _y)),(Object)(BA.ObjectToBoolean(RemoteObject.solveBoolean("!",_action,BA.numberCast(double.class, _p.getField(true,"TOUCH_ACTION_UP"))))));
...
try {
		Debug.PushSubsStack("DialogClosed (b4xdatetemplate) ","b4xdatetemplate",9,__ref.getField(false, "ba"),__ref,193);
...
Debug.JustUpdateDeviceLine();
__ref.runClassMethod (avanue.nvwa.b4xdatetemplate.class, "_setdate" /*RemoteObject*/ ,(Object)(__ref.getField(true,"_previousselecteddate" /*RemoteObject*/ )));
 };
...
try {
		Debug.PushSubsStack("DrawBox (b4xdatetemplate) ","b4xdatetemplate",9,__ref.getField(false, "ba"),__ref,91);
...
try {
		Debug.PushSubsStack("DrawDays (b4xdatetemplate) ","b4xdatetemplate",9,__ref.getField(false, "ba"),__ref,62);
...
Debug.JustUpdateDeviceLine();
__ref.runClassMethod (avanue.nvwa.b4xdatetemplate.class, "_setyearsbuttonstate" /*RemoteObject*/ );
...
Debug.JustUpdateDeviceLine();
__ref.runClassMethod (avanue.nvwa.b4xdatetemplate.class, "_drawbox" /*RemoteObject*/ ,(Object)(__ref.getField(false,"_cvs" /*RemoteObject*/ )),(Object)(__ref.getField(true,"_selectedcolor" /*RemoteObject*/ )),(Object)(RemoteObject.solve(new RemoteObject[] {(RemoteObject.solve(new RemoteObject[] {__ref.getField(true,"_selectedday" /*RemoteObject*/ ),RemoteObject.createImmutable(1),__ref.getField(true,"_dayofweekoffset" /*RemoteObject*/ )}, "-+",2, 1)),RemoteObject.createImmutable(7)}, "%",0, 1)),(Object)(BA.numberCast(int.class, RemoteObject.solve(new RemoteObject[] {(RemoteObject.solve(new RemoteObject[] {__ref.getField(true,"_selectedday" /*RemoteObject*/ ),RemoteObject.createImmutable(1),__ref.getField(true,"_dayofweekoffset" /*RemoteObject*/ )}, "-+",2, 1)),RemoteObject.createImmutable(7)}, "/",0, 0))));
 };
...
try {
		Debug.PushSubsStack("getDate (b4xdatetemplate) ","b4xdatetemplate",9,__ref.getField(false, "ba"),__ref,98);
...
try {
		Debug.PushSubsStack("GetPanel (b4xdatetemplate) ","b4xdatetemplate",9,__ref.getField(false, "ba"),__ref,172);
...
try {
		Debug.PushSubsStack("HandleMouse (b4xdatetemplate) ","b4xdatetemplate",9,__ref.getField(false, "ba"),__ref,123);
...
Debug.JustUpdateDeviceLine();
__ref.runClassMethod (avanue.nvwa.b4xdatetemplate.class, "_drawbox" /*RemoteObject*/ ,(Object)(__ref.getField(false,"_cvsbackground" /*RemoteObject*/ )),(Object)(__ref.getField(true,"_highlightedcolor" /*RemoteObject*/ )),(Object)(_boxx),(Object)(_boxy));
 };
 }else {
...
Debug.JustUpdateDeviceLine();
__ref.runClassMethod (avanue.nvwa.b4xdatetemplate.class, "_selectday" /*RemoteObject*/ ,(Object)(_newselectedday));
...
Debug.JustUpdateDeviceLine();
__ref.runClassMethod (avanue.nvwa.b4xdatetemplate.class, "_hide" /*RemoteObject*/ );
 }else {
...
try {
		Debug.PushSubsStack("Hide (b4xdatetemplate) ","b4xdatetemplate",9,__ref.getField(false, "ba"),__ref,149);
...
Debug.JustUpdateDeviceLine();
__ref.getField(false,"_mdialog" /*RemoteObject*/ ).runClassMethod (avanue.nvwa.b4xdialog.class, "_close" /*RemoteObject*/ ,(Object)(__ref.getField(false,"_xui" /*RemoteObject*/ ).getField(true,"DialogResponse_Positive")));
...
try {
		Debug.PushSubsStack("Initialize (b4xdatetemplate) ","b4xdatetemplate",9,__ref.getField(false, "ba"),__ref,37);
...
Debug.JustUpdateDeviceLine();
__ref.runClassMethod (avanue.nvwa.b4xdatetemplate.class, "_setdate" /*RemoteObject*/ ,(Object)(__ref.getField(true,"_selecteddate" /*RemoteObject*/ )));
...
try {
		Debug.PushSubsStack("SelectDay (b4xdatetemplate) ","b4xdatetemplate",9,__ref.getField(false, "ba"),__ref,115);
...
try {
		Debug.PushSubsStack("setDate (b4xdatetemplate) ","b4xdatetemplate",9,__ref.getField(false, "ba"),__ref,102);
...
Debug.JustUpdateDeviceLine();
__ref.runClassMethod (avanue.nvwa.b4xdatetemplate.class, "_selectday" /*RemoteObject*/ ,(Object)(b4xdatetemplate.__c.getField(false,"DateTime").runMethod(true,"GetDayOfMonth",(Object)(_date))));
...
try {
		Debug.PushSubsStack("SetYearsButtonState (b4xdatetemplate) ","b4xdatetemplate",9,__ref.getField(false, "ba"),__ref,86);
...
try {
		Debug.PushSubsStack("Show (b4xdatetemplate) ","b4xdatetemplate",9,__ref.getField(false, "ba"),__ref,176);
...
public ResumableSub_Show(avanue.nvwa.b4xdatetemplate parent,RemoteObject __ref,RemoteObject _dialog) {
this.parent = parent;
this.__ref = __ref;
