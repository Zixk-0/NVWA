...
try {
		Debug.PushSubsStack("AddItemsToList (b4xsearchtemplate) ","b4xsearchtemplate",19,__ref.getField(false, "ba"),__ref,128);
...
b4xsearchtemplate._xdialog = RemoteObject.createNew ("avanue.nvwa.b4xdialog");__ref.setField("_xdialog",b4xsearchtemplate._xdialog);
 //BA.debugLineNum = 6;BA.debugLine="Public SearchField As B4XFloatTextField";
b4xsearchtemplate._searchfield = RemoteObject.createNew ("avanue.nvwa.b4xfloattextfield");__ref.setField("_searchfield",b4xsearchtemplate._searchfield);
...
try {
		Debug.PushSubsStack("CustomListView1_ItemClick (b4xsearchtemplate) ","b4xsearchtemplate",19,__ref.getField(false, "ba"),__ref,122);
...
Debug.JustUpdateDeviceLine();
__ref.getField(false,"_xdialog" /*RemoteObject*/ ).runClassMethod (avanue.nvwa.b4xdialog.class, "_close" /*RemoteObject*/ ,(Object)(__ref.getField(false,"_xui" /*RemoteObject*/ ).getField(true,"DialogResponse_Positive")));
...
try {
		Debug.PushSubsStack("DialogClosed (b4xsearchtemplate) ","b4xsearchtemplate",19,__ref.getField(false, "ba"),__ref,241);
...
try {
		Debug.PushSubsStack("GetPanel (b4xsearchtemplate) ","b4xsearchtemplate",19,__ref.getField(false, "ba"),__ref,61);
...
try {
		Debug.PushSubsStack("Initialize (b4xsearchtemplate) ","b4xsearchtemplate",19,__ref.getField(false, "ba"),__ref,24);
...
_jo = RemoteObject.declareNull("anywheresoftware.b4a.AbsObjectWrapper").runMethod(false, "ConvertToWrapper", RemoteObject.createNew("anywheresoftware.b4j.object.JavaObject"), __ref.getField(false,"_searchfield" /*RemoteObject*/ ).runClassMethod (avanue.nvwa.b4xfloattextfield.class, "_gettextfield" /*RemoteObject*/ ).getObject());Debug.locals.put("jo", _jo);Debug.locals.put("jo", _jo);
...
try {
		Debug.PushSubsStack("Resize (b4xsearchtemplate) ","b4xsearchtemplate",19,__ref.getField(false, "ba"),__ref,54);
...
try {
		Debug.PushSubsStack("SearchField_EnterPressed (b4xsearchtemplate) ","b4xsearchtemplate",19,__ref.getField(false, "ba"),__ref,112);
...
Debug.JustUpdateDeviceLine();
__ref.runClassMethod (avanue.nvwa.b4xsearchtemplate.class, "_customlistview1_itemclick" /*RemoteObject*/ ,(Object)(BA.numberCast(int.class, 0)),(Object)(__ref.getField(false,"_customlistview1" /*RemoteObject*/ ).runMethod(false,"_getvalue",(Object)(BA.numberCast(int.class, 0)))));
 }}
;
...
try {
		Debug.PushSubsStack("SearchField_TextChanged (b4xsearchtemplate) ","b4xsearchtemplate",19,__ref.getField(false, "ba"),__ref,81);
...
Debug.JustUpdateDeviceLine();
__ref.runClassMethod (avanue.nvwa.b4xsearchtemplate.class, "_update" /*RemoteObject*/ ,(Object)(_new),(Object)(b4xsearchtemplate.__c.getField(true,"False")));
...
try {
		Debug.PushSubsStack("SetIndex (b4xsearchtemplate) ","b4xsearchtemplate",19,__ref.getField(false, "ba"),__ref,233);
...
try {
		Debug.PushSubsStack("SetItems (b4xsearchtemplate) ","b4xsearchtemplate",19,__ref.getField(false, "ba"),__ref,196);
...
try {
		Debug.PushSubsStack("Show (b4xsearchtemplate) ","b4xsearchtemplate",19,__ref.getField(false, "ba"),__ref,65);
...
public ResumableSub_Show(avanue.nvwa.b4xsearchtemplate parent,RemoteObject __ref,RemoteObject _dialog) {
this.parent = parent;
this.__ref = __ref;
...
Debug.JustUpdateDeviceLine();
__ref.runClassMethod (avanue.nvwa.b4xsearchtemplate.class, "_update" /*RemoteObject*/ ,(Object)(BA.ObjectToString("")),(Object)(parent.__c.getField(true,"True")));
...
Debug.JustUpdateDeviceLine();
__ref.getField(false,"_searchfield" /*RemoteObject*/ ).runClassMethod (avanue.nvwa.b4xfloattextfield.class, "_settext" /*RemoteObject*/ ,BA.ObjectToString(""));
 BA.debugLineNum = 75;BA.debugLine="SearchField.TextField.RequestFocus";
Debug.JustUpdateDeviceLine();
__ref.getField(false,"_searchfield" /*RemoteObject*/ ).runClassMethod (avanue.nvwa.b4xfloattextfield.class, "_gettextfield" /*RemoteObject*/ ).runVoidMethod ("RequestFocus");
 BA.debugLineNum = 77;BA.debugLine="IME.ShowKeyboard(SearchField.TextField)";
Debug.JustUpdateDeviceLine();
__ref.getField(false,"_ime" /*RemoteObject*/ ).runVoidMethod ("ShowKeyboard",(Object)((__ref.getField(false,"_searchfield" /*RemoteObject*/ ).runClassMethod (avanue.nvwa.b4xfloattextfield.class, "_gettextfield" /*RemoteObject*/ ).getObject())));
...
try {
		Debug.PushSubsStack("Update (b4xsearchtemplate) ","b4xsearchtemplate",19,__ref.getField(false, "ba"),__ref,85);
...
Debug.JustUpdateDeviceLine();
__ref.runClassMethod (avanue.nvwa.b4xsearchtemplate.class, "_additemstolist" /*RemoteObject*/ ,(Object)(__ref.getField(false,"_allitems" /*RemoteObject*/ )),(Object)(_str1));
 }else {
...
Debug.JustUpdateDeviceLine();
__ref.runClassMethod (avanue.nvwa.b4xsearchtemplate.class, "_additemstolist" /*RemoteObject*/ ,RemoteObject.declareNull("anywheresoftware.b4a.AbsObjectWrapper").runMethod(false, "ConvertToWrapper", RemoteObject.createNew("anywheresoftware.b4a.objects.collections.List"), __ref.getField(false,"_prefixlist" /*RemoteObject*/ ).runMethod(false,"Get",(Object)((_str2)))),(Object)(_str1));
